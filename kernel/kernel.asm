...
0000000080000000 <_entry>:
    ...
    80000016:	5ba050ef          	jal	ra,800055d0 <start>
    ...
    80000508:	8082                	ret
{
  ...
  if((*pte & PTE_U) == 0)
    ...
    80000532:	8082                	ret
  pa = PTE2PA(*pte);
    80000534:	83a9                	srli	a5,a5,0xa
    80000536:	00c79513          	slli	a0,a5,0xc
  return pa;
...
mappages(pagetable_t pagetable, uint64 va, uint64 size, uint64 pa, int perm)
{
  ...
  last = PGROUNDDOWN(va + size - 1);
    80000562:	fff58993          	addi	s3,a1,-1
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    800009a2:	75a50513          	addi	a0,a0,1882 # 800080f8 <etext+0xf8>
    ...
    80000a02:	c679                	beqz	a2,80000ad0 <uvmcopy+0xce>
{
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    flags = PTE_FLAGS(*pte);
    80000a42:	3ff77493          	andi	s1,a4,1023
    if((mem = kalloc()) == 0)
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80000a80:	68c50513          	addi	a0,a0,1676 # 80008108 <etext+0x108>
    80000a84:	00005097          	auipc	ra,0x5
    80000a88:	ff6080e7          	jalr	-10(ra) # 80005a7a <panic>
      panic("uvmcopy: page not present");
    80000a8c:	00007517          	auipc	a0,0x7
    80000a90:	69c50513          	addi	a0,a0,1692 # 80008128 <etext+0x128>
 ...
 err:
  uvmunmap(new, 0, i / PGSIZE, 1);
    ...
    80000aa8:	00c9d613          	srli	a2,s3,0xc
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000afa:	65250513          	addi	a0,a0,1618 # 80008148 <etext+0x148>
...
000000008000119c <growproc>:
{
  ...
  p->sz = sz;
    800011c2:	1782                	slli	a5,a5,0x20
    800011c4:	9381                	srli	a5,a5,0x20
...
0000000080001354 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001374:	ce070713          	addi	a4,a4,-800 # 80009050 <pid_lock>
    80001378:	9756                	add	a4,a4,s5
    8000137a:	02073823          	sd	zero,48(a4)
        swtch(&c->context, &p->context);
    8000137e:	00008717          	auipc	a4,0x8
    80001382:	d0a70713          	addi	a4,a4,-758 # 80009088 <cpus+0x8>
    ...
    80001392:	cc2a0a13          	addi	s4,s4,-830 # 80009050 <pid_lock>
    80001396:	9a3e                	add	s4,s4,a5
    for(p = proc; p < &proc[NPROC]; p++) {
    80001398:	0000e917          	auipc	s2,0xe
    8000139c:	ae890913          	addi	s2,s2,-1304 # 8000ee80 <tickslock>
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800013b0:	0d448493          	addi	s1,s1,212 # 80009480 <proc>
    ...
    for(p = proc; p < &proc[NPROC]; p++) {
    800013c0:	16848493          	addi	s1,s1,360
...
00000000800013f4 <sched>:
{
  ...
  if(mycpu()->noff != 1)
    ...
    80001420:	c3470713          	addi	a4,a4,-972 # 80009050 <pid_lock>
  ...
  intena = mycpu()->intena;
    ...
    80001446:	c0e90913          	addi	s2,s2,-1010 # 80009050 <pid_lock>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    8000145e:	c2e58593          	addi	a1,a1,-978 # 80009088 <cpus+0x8>
...
000000008000156a <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    80001592:	ada50513          	addi	a0,a0,-1318 # 80009068 <wait_lock>
    ...
    800015a8:	8dc98993          	addi	s3,s3,-1828 # 8000ee80 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    800015ac:	00008c17          	auipc	s8,0x8
    800015b0:	abcc0c13          	addi	s8,s8,-1348 # 80009068 <wait_lock>
    ...
    800015c0:	02c48613          	addi	a2,s1,44
    ...
    800015ee:	a7e50513          	addi	a0,a0,-1410 # 80009068 <wait_lock>
    ...
    80001678:	e0c48493          	addi	s1,s1,-500 # 80009480 <proc>
...
wakeup(void *chan)
{
    ...
    800016a2:	0080                	addi	s0,sp,64
    800016a4:	8a2a                	mv	s4,a0
  struct proc *p;

  for(p = proc; p < &proc[NPROC]; p++) {
    800016a6:	00008497          	auipc	s1,0x8
    800016aa:	dda48493          	addi	s1,s1,-550 # 80009480 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800016b6:	7ce90913          	addi	s2,s2,1998 # 8000ee80 <tickslock>
...
0000000080001708 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    80001726:	8eea0a13          	addi	s4,s4,-1810 # 80009010 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    8000172a:	0000d997          	auipc	s3,0xd
    8000172e:	75698993          	addi	s3,s3,1878 # 8000ee80 <tickslock>
    80001732:	a029                	j	8000173c <reparent+0x34>
    80001734:	16848493          	addi	s1,s1,360
...
0000000080001762 <exit>:
{
  ...
  if(p == initproc)
    ...
    80001786:	0d050493          	addi	s1,a0,208
    8000178a:	15050913          	addi	s2,a0,336
    8000178e:	02a79363          	bne	a5,a0,800017b4 <exit+0x52>
    panic("init exiting");
    80001792:	00007517          	auipc	a0,0x7
    80001796:	a4e50513          	addi	a0,a0,-1458 # 800081e0 <etext+0x1e0>
  ...
  acquire(&wait_lock);
    ...
    800017de:	88e48493          	addi	s1,s1,-1906 # 80009068 <wait_lock>
  ...
  panic("zombie exit");
    ...
    8000182c:	9c850513          	addi	a0,a0,-1592 # 800081f0 <etext+0x1f0>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001854:	63098993          	addi	s3,s3,1584 # 8000ee80 <tickslock>
    acquire(&p->lock);
...
procdump(void)
{
  ...
  printf("\n");
    ...
    80001970:	6dc50513          	addi	a0,a0,1756 # 80008048 <etext+0x48>
    80001974:	00004097          	auipc	ra,0x4
    80001978:	150080e7          	jalr	336(ra) # 80005ac4 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    8000197c:	00008497          	auipc	s1,0x8
    80001980:	c5c48493          	addi	s1,s1,-932 # 800095d8 <proc+0x158>
    80001984:	0000d917          	auipc	s2,0xd
    80001988:	65490913          	addi	s2,s2,1620 # 8000efd8 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
    ...
    80001992:	87298993          	addi	s3,s3,-1934 # 80008200 <etext+0x200>
    printf("%d %s %s", p->pid, state, p->name);
    80001996:	00007a97          	auipc	s5,0x7
    8000199a:	872a8a93          	addi	s5,s5,-1934 # 80008208 <etext+0x208>
    printf("\n");
    8000199e:	00006a17          	auipc	s4,0x6
    800019a2:	6aaa0a13          	addi	s4,s4,1706 # 80008048 <etext+0x48>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
    800019a6:	00007b97          	auipc	s7,0x7
    800019aa:	89ab8b93          	addi	s7,s7,-1894 # 80008240 <states.0>
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    800019c8:	16848493          	addi	s1,s1,360
    ...
    800019de:	02079713          	slli	a4,a5,0x20
    800019e2:	01d75793          	srli	a5,a4,0x1d
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001a7c:	7f858593          	addi	a1,a1,2040 # 80008270 <states.0+0x30>
    80001a80:	0000d517          	auipc	a0,0xd
    80001a84:	40050513          	addi	a0,a0,1024 # 8000ee80 <tickslock>
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80001aa2:	44278793          	addi	a5,a5,1090 # 80004ee0 <kernelvec>
...
usertrapret(void)
{
  ...
  w_stvec(TRAMPOLINE + (uservec - trampoline));
    ...
    80001ad6:	52e70713          	addi	a4,a4,1326 # 80007000 <_trampoline>
    80001ada:	8f15                	sub	a4,a4,a3
    80001adc:	040007b7          	lui	a5,0x4000
    80001ae0:	17fd                	addi	a5,a5,-1 # 3ffffff <_entry-0x7c000001>
    80001ae2:	07b2                	slli	a5,a5,0xc
  ...
  p->trapframe->kernel_trap = (uint64)usertrap;
    ...
    80001b02:	13c60613          	addi	a2,a2,316 # 80001c3a <usertrap>
  ...
  x &= ~SSTATUS_SPP; // clear SPP to 0 for user mode
    80001b12:	eff77713          	andi	a4,a4,-257
  x |= SSTATUS_SPIE; // enable interrupts in user mode
    80001b16:	02076713          	ori	a4,a4,32
  asm volatile("csrw sstatus, %0" : : "r" (x));
  ...
  uint64 fn = TRAMPOLINE + (userret - trampoline);
    ...
    80001b2e:	56670713          	addi	a4,a4,1382 # 80007090 <userret>
  ...
  ((void (*)(uint64,uint64))fn)(TRAPFRAME, satp);
    ...
    80001b40:	157d                	addi	a0,a0,-1 # 1ffffff <_entry-0x7e000001>
    80001b42:	0536                	slli	a0,a0,0xd
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001b5c:	32848493          	addi	s1,s1,808 # 8000ee80 <tickslock>
  ...
  ticks++;
    ...
    80001b6e:	4ae50513          	addi	a0,a0,1198 # 80009018 <ticks>
...
0000000080001c3a <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80001c54:	29078793          	addi	a5,a5,656 # 80004ee0 <kernelvec>
  ...
  usertrapret();
    ...
    80001cb4:	5e850513          	addi	a0,a0,1512 # 80008298 <states.0+0x58>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001ce8:	5d450513          	addi	a0,a0,1492 # 800082b8 <states.0+0x78>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001d00:	5ec50513          	addi	a0,a0,1516 # 800082e8 <states.0+0xa8>
...
0000000080001d2e <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001d80:	58c50513          	addi	a0,a0,1420 # 80008308 <states.0+0xc8>
    80001d84:	00004097          	auipc	ra,0x4
    80001d88:	cf6080e7          	jalr	-778(ra) # 80005a7a <panic>
    panic("kerneltrap: interrupts enabled");
    80001d8c:	00006517          	auipc	a0,0x6
    80001d90:	5a450513          	addi	a0,a0,1444 # 80008330 <states.0+0xf0>
    ...
    80001da2:	5b250513          	addi	a0,a0,1458 # 80008350 <states.0+0x110>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001dba:	5aa50513          	addi	a0,a0,1450 # 80008360 <states.0+0x120>
    80001dbe:	00004097          	auipc	ra,0x4
    80001dc2:	d06080e7          	jalr	-762(ra) # 80005ac4 <printf>
    panic("kerneltrap");
    80001dc6:	00006517          	auipc	a0,0x6
    80001dca:	5b250513          	addi	a0,a0,1458 # 80008378 <states.0+0x138>
...
argraw(int n)
{
  ...
  switch (n) {
    ...
    80001e1a:	59a70713          	addi	a4,a4,1434 # 800083b0 <states.0+0x170>
  ...
  panic("argraw");
    ...
    80001e56:	53650513          	addi	a0,a0,1334 # 80008388 <states.0+0x148>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    80001f92:	37fd                	addiw	a5,a5,-1
    80001f94:	4751                	li	a4,20
    80001f96:	00f76f63          	bltu	a4,a5,80001fb4 <syscall+0x44>
    80001f9a:	00369713          	slli	a4,a3,0x3
    80001f9e:	00006797          	auipc	a5,0x6
    80001fa2:	42a78793          	addi	a5,a5,1066 # 800083c8 <syscalls>
    ...
    80001fb4:	15848613          	addi	a2,s1,344
    80001fb8:	588c                	lw	a1,48(s1)
    80001fba:	00006517          	auipc	a0,0x6
    80001fbe:	3d650513          	addi	a0,a0,982 # 80008390 <states.0+0x150>
...
sys_fork(void)
{
    8000202a:	1141                	addi	sp,sp,-16
    8000202c:	e406                	sd	ra,8(sp)
    8000202e:	e022                	sd	s0,0(sp)
    80002030:	0800                	addi	s0,sp,16
  return fork();
...
sys_sbrk(void)
{
  ...
  if(argint(0, &n) < 0)
    8000207e:	fdc40593          	addi	a1,s0,-36
...
sys_sleep(void)
{
  ...
  if(argint(0, &n) < 0)
    800020cc:	fcc40593          	addi	a1,s0,-52
  ...
  acquire(&tickslock);
    ...
    800020e4:	da050513          	addi	a0,a0,-608 # 8000ee80 <tickslock>
  ...
  while(ticks - ticks0 < n){
    ...
    80002102:	d8298993          	addi	s3,s3,-638 # 8000ee80 <tickslock>
    80002106:	00007497          	auipc	s1,0x7
    8000210a:	f1248493          	addi	s1,s1,-238 # 80009018 <ticks>
    if(myproc()->killed){
  ...
  release(&tickslock);
    ...
    80002138:	d4c50513          	addi	a0,a0,-692 # 8000ee80 <tickslock>
  ...
  return 0;
    ...
    8000215a:	d2a50513          	addi	a0,a0,-726 # 8000ee80 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    800021aa:	cda50513          	addi	a0,a0,-806 # 8000ee80 <tickslock>
  ...
  return xticks;
    ...
    800021ce:	02049513          	slli	a0,s1,0x20
    800021d2:	9101                	srli	a0,a0,0x20
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    800021f2:	28a58593          	addi	a1,a1,650 # 80008478 <syscalls+0xb0>
    800021f6:	0000d517          	auipc	a0,0xd
    800021fa:	ca250513          	addi	a0,a0,-862 # 8000ee98 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    8000220a:	c9278793          	addi	a5,a5,-878 # 80016e98 <bcache+0x8000>
    8000220e:	00015717          	auipc	a4,0x15
    80002212:	ef270713          	addi	a4,a4,-270 # 80017100 <bcache+0x8268>
    80002216:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    8000221a:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    8000221e:	0000d497          	auipc	s1,0xd
    80002222:	c9248493          	addi	s1,s1,-878 # 8000eeb0 <bcache+0x18>
    ...
    8000222e:	256a0a13          	addi	s4,s4,598 # 80008480 <syscalls+0xb8>
    b->next = bcache.head.next;
    ...
    8000223e:	01048513          	addi	a0,s1,16
  ...
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002254:	45848493          	addi	s1,s1,1112
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002282:	c1a50513          	addi	a0,a0,-998 # 8000ee98 <bcache>
  ...
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    8000229a:	e6a78793          	addi	a5,a5,-406 # 80017100 <bcache+0x8268>
    ...
    800022c2:	bda50513          	addi	a0,a0,-1062 # 8000ee98 <bcache>
    800022c6:	00004097          	auipc	ra,0x4
    800022ca:	da0080e7          	jalr	-608(ra) # 80006066 <release>
      acquiresleep(&b->lock);
    800022ce:	01048513          	addi	a0,s1,16
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    800022e8:	e1c78793          	addi	a5,a5,-484 # 80017100 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002300:	18c50513          	addi	a0,a0,396 # 80008488 <syscalls+0xc0>
    ...
    80002320:	b7c50513          	addi	a0,a0,-1156 # 8000ee98 <bcache>
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002390:	11450513          	addi	a0,a0,276 # 800084a0 <syscalls+0xd8>
...
brelse(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    800023aa:	01050913          	addi	s2,a0,16
...
00000000800028d2 <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    800028fe:	c5ea0a13          	addi	s4,s4,-930 # 80017558 <sb>
    80002902:	00495593          	srli	a1,s2,0x4
    ...
    80002918:	05850993          	addi	s3,a0,88
    8000291c:	00f97793          	andi	a5,s2,15
  ...
  panic("ialloc: no inodes");
    ...
    80002944:	bf050513          	addi	a0,a0,-1040 # 80008530 <syscalls+0x168>
...
000000008000299a <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    800029aa:	0047d79b          	srliw	a5,a5,0x4
...
write_head(void)
{
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000328a:	dca70713          	addi	a4,a4,-566 # 80019050 <log+0x30>
    8000328e:	87aa                	mv	a5,a0
    80003290:	060a                	slli	a2,a2,0x2
    ...
    800032c8:	0af05d63          	blez	a5,80003382 <install_trans+0xc2>
{
    ...
    800032e6:	d6ea8a93          	addi	s5,s5,-658 # 80019050 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    800032ea:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    800032ec:	00016997          	auipc	s3,0x16
    800032f0:	d3498993          	addi	s3,s3,-716 # 80019020 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    8000330a:	2a05                	addiw	s4,s4,1
    8000330c:	0a91                	addi	s5,s5,4
    ...
    80003344:	05890593          	addi	a1,s2,88
...
0000000080003384 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    8000339a:	c8a48493          	addi	s1,s1,-886 # 80019020 <log>
    8000339e:	00005597          	auipc	a1,0x5
    800033a2:	20258593          	addi	a1,a1,514 # 800085a0 <syscalls+0x1d8>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800033d8:	c7c70713          	addi	a4,a4,-900 # 80019050 <log+0x30>
    800033dc:	060a                	slli	a2,a2,0x2
...
begin_op(void)
{
  ...
  while(1){
    ...
    8000347c:	ba850513          	addi	a0,a0,-1112 # 80019020 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800034ac:	b7848493          	addi	s1,s1,-1160 # 80019020 <log>
  ...
  if(log.outstanding == 0){
    ...
    800034d0:	b5448493          	addi	s1,s1,-1196 # 80019020 <log>
...
commit()
{
  ...
  release(&log.lock);
    ...
    8000354e:	6121                	addi	sp,sp,64
    80003550:	8082                	ret
  for (tail = 0; tail < log.lh.n; tail++) {
    80003552:	00016a97          	auipc	s5,0x16
    80003556:	afea8a93          	addi	s5,s5,-1282 # 80019050 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    8000355a:	00016a17          	auipc	s4,0x16
    8000355e:	ac6a0a13          	addi	s4,s4,-1338 # 80019020 <log>
    80003562:	018a2583          	lw	a1,24(s4)
    80003566:	012585bb          	addw	a1,a1,s2
    8000356a:	2585                	addiw	a1,a1,1
    ...
    80003594:	05848513          	addi	a0,s1,88
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    80003600:	a2490913          	addi	s2,s2,-1500 # 80019020 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000363e:	a1670713          	addi	a4,a4,-1514 # 80019050 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    80003652:	0621                	addi	a2,a2,8
    80003654:	060a                	slli	a2,a2,0x2
    80003656:	00016797          	auipc	a5,0x16
    8000365a:	9ca78793          	addi	a5,a5,-1590 # 80019020 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80003672:	9b270713          	addi	a4,a4,-1614 # 80019020 <log>
  ...
  release(&log.lock);
    ...
    800036ba:	96a50513          	addi	a0,a0,-1686 # 80019020 <log>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    800036e6:	f0e58593          	addi	a1,a1,-242 # 800085f0 <syscalls+0x228>
    800036ea:	0521                	addi	a0,a0,8
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    8000371a:	00850913          	addi	s2,a0,8
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    80003770:	00850913          	addi	s2,a0,8
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80003808:	dfc58593          	addi	a1,a1,-516 # 80008600 <syscalls+0x238>
    8000380c:	00016517          	auipc	a0,0x16
    80003810:	95c50513          	addi	a0,a0,-1700 # 80019168 <ftable>
...
filealloc(void)
{
  ...
  release(&ftable.lock);
    ...
    8000385e:	90e50513          	addi	a0,a0,-1778 # 80019168 <ftable>
  ...
  return 0;
    ...
    80003876:	8f650513          	addi	a0,a0,-1802 # 80019168 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000389e:	8ce50513          	addi	a0,a0,-1842 # 80019168 <ftable>
  ...
  release(&ftable.lock);
    ...
    800038b8:	8b450513          	addi	a0,a0,-1868 # 80019168 <ftable>
  ...
  return f;
    ...
    800038d4:	d3850513          	addi	a0,a0,-712 # 80008608 <syscalls+0x240>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800038f8:	87450513          	addi	a0,a0,-1932 # 80019168 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003932:	83a50513          	addi	a0,a0,-1990 # 80019168 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    8000396c:	ca850513          	addi	a0,a0,-856 # 80008610 <syscalls+0x248>
    80003970:	00002097          	auipc	ra,0x2
    80003974:	10a080e7          	jalr	266(ra) # 80005a7a <panic>
    release(&ftable.lock);
    80003978:	00015517          	auipc	a0,0x15
    8000397c:	7f050513          	addi	a0,a0,2032 # 80019168 <ftable>
...
filestat(struct file *f, uint64 addr)
{
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    ...
    stati(f->ip, &st);
    800039d8:	fb840593          	addi	a1,s0,-72
    ...
    800039f2:	fb840613          	addi	a2,s0,-72
    ...
    80003a04:	41f5551b          	sraiw	a0,a0,0x1f
      return -1;
    return 0;
  }
  return -1;
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80003a9c:	03079693          	slli	a3,a5,0x30
    80003aa0:	92c1                	srli	a3,a3,0x30
    80003aa2:	4725                	li	a4,9
    80003aa4:	02d76863          	bltu	a4,a3,80003ad4 <fileread+0xba>
    80003aa8:	0792                	slli	a5,a5,0x4
    80003aaa:	00015717          	auipc	a4,0x15
    80003aae:	61e70713          	addi	a4,a4,1566 # 800190c8 <devsw>
    ...
    80003ac4:	b6050513          	addi	a0,a0,-1184 # 80008620 <syscalls+0x258>
    ...
    80003ae0:	10078e63          	beqz	a5,80003bfc <filewrite+0x120>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003b1e:	c00b8b93          	addi	s7,s7,-1024 # c00 <_entry-0x7ffff400>
    80003b22:	6c05                	lui	s8,0x1
    80003b24:	c00c0c1b          	addiw	s8,s8,-1024 # c00 <_entry-0x7ffff400>
    ...
    80003b3a:	03079693          	slli	a3,a5,0x30
    80003b3e:	92c1                	srli	a3,a3,0x30
    80003b40:	4725                	li	a4,9
    80003b42:	0ad76f63          	bltu	a4,a3,80003c00 <filewrite+0x124>
    80003b46:	0792                	slli	a5,a5,0x4
    80003b48:	00015717          	auipc	a4,0x15
    80003b4c:	58070713          	addi	a4,a4,1408 # 800190c8 <devsw>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003c64:	9e058593          	addi	a1,a1,-1568 # 80008640 <syscalls+0x278>
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  if(writable){
    ...
    wakeup(&pi->nread);
    80003d06:	21848513          	addi	a0,s1,536
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    wakeup(&pi->nwrite);
    80003d3c:	21c48513          	addi	a0,s1,540
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  int i = 0;
    ...
    80003d8e:	5b7d                	li	s6,-1
      wakeup(&pi->nread);
    80003d90:	21848c13          	addi	s8,s1,536
      sleep(&pi->nwrite, &pi->lock);
    80003d94:	21c48b93          	addi	s7,s1,540
  ...
  wakeup(&pi->nread);
    80003e30:	21848513          	addi	a0,s1,536
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    80003e7e:	21848993          	addi	s3,s1,536
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80003eec:	2985                	addiw	s3,s3,1
    80003eee:	0905                	addi	s2,s2,1
...
{
    80003f30:	df010113          	addi	sp,sp,-528
  ...
  if(readi(ip, 0, (uint64)&elf, 0, sizeof(elf)) != sizeof(elf))
    ...
    80003f8c:	e5040613          	addi	a2,s0,-432
  ...
  if(elf.magic != ELF_MAGIC)
    ...
    80003fac:	57f78793          	addi	a5,a5,1407 # 464c457f <_entry-0x39b3ba81>
 ...
 bad:
  ...
  return -1;
    ...
    80003fe6:	21010113          	addi	sp,sp,528
    80003fea:	8082                	ret
    end_op();
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    ...
    80004016:	fffc8793          	addi	a5,s9,-1 # fff <_entry-0x7ffff001>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004026:	62650513          	addi	a0,a0,1574 # 80008648 <syscalls+0x280>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    pa = walkaddr(pagetable, va + i);
    80004054:	02091593          	slli	a1,s2,0x20
    80004058:	9181                	srli	a1,a1,0x20
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    8000407e:	2d85                	addiw	s11,s11,1
    80004080:	038d0d1b          	addiw	s10,s10,56
    ...
    80004094:	e1840613          	addi	a2,s0,-488
  ...
  sz = PGROUNDUP(sz);
    ...
    8000412a:	19fd                	addi	s3,s3,-1 # fff <_entry-0x7ffff001>
  ...
  for(argc = 0; argv[argc]; argc++) {
    ...
    800041a2:	0015069b          	addiw	a3,a0,1
  ...
  ustack[argc] = 0;
    800041dc:	00349793          	slli	a5,s1,0x3
    800041e0:	f9078793          	addi	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffd8d50>
    800041e4:	97a2                	add	a5,a5,s0
    800041e6:	f007b023          	sd	zero,-256(a5)
  sp -= (argc+1) * sizeof(uint64);
    800041ea:	00148693          	addi	a3,s1,1
    800041ee:	068e                	slli	a3,a3,0x3
    800041f0:	40d90933          	sub	s2,s2,a3
  sp -= sp % 16;
    800041f4:	ff097913          	andi	s2,s2,-16
  sz = sz1;
    800041f8:	e0843983          	ld	s3,-504(s0)
  if(sp < stackbase)
    800041fc:	f57968e3          	bltu	s2,s7,8000414c <exec+0x21c>
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    80004200:	e9040613          	addi	a2,s0,-368
  ...
  safestrcpy(p->name, last, sizeof(p->name));
    ...
    80004246:	158a8513          	addi	a0,s5,344
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  if(argint(n, &fd) < 0)
    800042ce:	fdc40593          	addi	a1,s0,-36
  ...
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    800042f4:	01a70793          	addi	a5,a4,26
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    8000433c:	0d050793          	addi	a5,a0,208
  ...
  for(fd = 0; fd < NOFILE; fd++){
    80004348:	2505                	addiw	a0,a0,1
    8000434a:	07a1                	addi	a5,a5,8
  ...
  return -1;
    ...
    8000435a:	8082                	ret
      p->ofile[fd] = f;
    8000435c:	01a50793          	addi	a5,a0,26
    80004360:	078e                	slli	a5,a5,0x3
...
create(char *path, short type, short major, short minor)
{
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    8000439c:	fb040593          	addi	a1,s0,-80
    ...
    800043cc:	37f9                	addiw	a5,a5,-2
    800043ce:	17c2                	slli	a5,a5,0x30
    800043d0:	93c1                	srli	a5,a5,0x30
  ...
  if(dirlink(dp, name, ip->inum) < 0)
    ...
    80004432:	fb040593          	addi	a1,s0,-80
  ...
  return ip;
    ...
    80004454:	21850513          	addi	a0,a0,536 # 80008668 <syscalls+0x2a0>
    ...
    8000447a:	20258593          	addi	a1,a1,514 # 80008678 <syscalls+0x2b0>
    ...
    80004494:	1f058593          	addi	a1,a1,496 # 80008680 <syscalls+0x2b8>
    ...
    800044aa:	1e250513          	addi	a0,a0,482 # 80008688 <syscalls+0x2c0>
    800044ae:	00001097          	auipc	ra,0x1
    800044b2:	5cc080e7          	jalr	1484(ra) # 80005a7a <panic>
    panic("create: dirlink");
    800044b6:	00004517          	auipc	a0,0x4
    800044ba:	1e250513          	addi	a0,a0,482 # 80008698 <syscalls+0x2d0>
...
00000000800044ca <sys_dup>:
{
  ...
  if(argfd(0, 0, &f) < 0)
    800044d6:	fd840613          	addi	a2,s0,-40
...
000000008000451c <sys_read>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80004524:	fe840613          	addi	a2,s0,-24
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    8000453a:	fe440593          	addi	a1,s0,-28
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    8000454e:	fd840593          	addi	a1,s0,-40
...
0000000080004582 <sys_write>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    8000458a:	fe840613          	addi	a2,s0,-24
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    800045a0:	fe440593          	addi	a1,s0,-28
...
00000000800045e8 <sys_close>:
{
  ...
  if(argfd(0, &fd, &f) < 0)
    800045f0:	fe040613          	addi	a2,s0,-32
    800045f4:	fec40593          	addi	a1,s0,-20
...
0000000080004636 <sys_fstat>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    8000463e:	fe840613          	addi	a2,s0,-24
  ...
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    ...
    80004654:	fe040593          	addi	a1,s0,-32
...
0000000080004684 <sys_link>:
{
    ...
    8000468e:	1a00                	addi	s0,sp,304
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    80004690:	08000613          	li	a2,128
    80004694:	ed040593          	addi	a1,s0,-304
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    800046ac:	f5040593          	addi	a1,s0,-176
  ...
  if((ip = namei(old)) == 0){
    800046c8:	ed040513          	addi	a0,s0,-304
  ...
  if((dp = nameiparent(new, name)) == 0)
    ...
    8000470c:	f5040513          	addi	a0,s0,-176
  ...
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
    ...
    80004730:	fd040593          	addi	a1,s0,-48
  ...
  return -1;
    ...
    800047ca:	6155                	addi	sp,sp,304
    800047cc:	8082                	ret

00000000800047ce <sys_unlink>:
{
    800047ce:	7151                	addi	sp,sp,-240
    ...
    800047da:	1980                	addi	s0,sp,240
  if(argstr(0, path, MAXPATH) < 0)
    800047dc:	08000613          	li	a2,128
    800047e0:	f3040593          	addi	a1,s0,-208
  ...
  if((dp = nameiparent(path, name)) == 0){
    800047fa:	fb040593          	addi	a1,s0,-80
    800047fe:	f3040513          	addi	a0,s0,-208
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    8000481a:	e6258593          	addi	a1,a1,-414 # 80008678 <syscalls+0x2b0>
    8000481e:	fb040513          	addi	a0,s0,-80
    ...
    80004832:	e5258593          	addi	a1,a1,-430 # 80008680 <syscalls+0x2b8>
    80004836:	fb040513          	addi	a0,s0,-80
  ...
  if((ip = dirlookup(dp, name, &off)) == 0)
    80004846:	f2c40613          	addi	a2,s0,-212
  ...
  memset(&de, 0, sizeof(de));
    ...
    8000487c:	fc040513          	addi	a0,s0,-64
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    8000488e:	fc040613          	addi	a2,s0,-64
  ...
  return 0;
    ...
    800048f2:	dba50513          	addi	a0,a0,-582 # 800086a8 <syscalls+0x2e0>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80004912:	f1840613          	addi	a2,s0,-232
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    8000493e:	d8650513          	addi	a0,a0,-634 # 800086c0 <syscalls+0x2f8>
    80004942:	00001097          	auipc	ra,0x1
    80004946:	138080e7          	jalr	312(ra) # 80005a7a <panic>
    panic("unlink: writei");
    8000494a:	00004517          	auipc	a0,0x4
    8000494e:	d8e50513          	addi	a0,a0,-626 # 800086d8 <syscalls+0x310>
...
sys_open(void)
{
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    800049b2:	f5040593          	addi	a1,s0,-176
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    800049c6:	f4c40593          	addi	a1,s0,-180
  ...
  f->readable = !(omode & O_WRONLY);
    ...
    80004a4a:	0017c713          	xori	a4,a5,1
    80004a4e:	8b05                	andi	a4,a4,1
    80004a50:	00e98423          	sb	a4,8(s3)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
    80004a54:	0037f713          	andi	a4,a5,3
    80004a58:	00e03733          	snez	a4,a4
    80004a5c:	00e984a3          	sb	a4,9(s3)

  if((omode & O_TRUNC) && ip->type == T_FILE){
    80004a60:	4007f793          	andi	a5,a5,1024
  ...
  return fd;
    ...
    if((ip = namei(path)) == 0){
    80004a9c:	f5040513          	addi	a0,s0,-176
...
sys_mkdir(void)
{
    80004b36:	7175                	addi	sp,sp,-144
    80004b38:	e506                	sd	ra,136(sp)
    80004b3a:	e122                	sd	s0,128(sp)
    80004b3c:	0900                	addi	s0,sp,144
  char path[MAXPATH];
  struct inode *ip;
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80004b4a:	f7040593          	addi	a1,s0,-144
    ...
    80004b62:	f7040513          	addi	a0,s0,-144
...
sys_mknod(void)
{
    80004b96:	7135                	addi	sp,sp,-160
    80004b98:	ed06                	sd	ra,152(sp)
    80004b9a:	e922                	sd	s0,144(sp)
    80004b9c:	1100                	addi	s0,sp,160
  struct inode *ip;
  char path[MAXPATH];
  int major, minor;
  ...
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    80004baa:	f7040593          	addi	a1,s0,-144
    ...
    80004bb8:	04054a63          	bltz	a0,80004c0c <sys_mknod+0x76>
     argint(1, &major) < 0 ||
    80004bbc:	f6c40593          	addi	a1,s0,-148
  ...
  if((argstr(0, path, MAXPATH)) < 0 ||
    80004bca:	04054163          	bltz	a0,80004c0c <sys_mknod+0x76>
     argint(2, &minor) < 0 ||
    80004bce:	f6840593          	addi	a1,s0,-152
    ...
    80004bea:	f7040513          	addi	a0,s0,-144
...
sys_chdir(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    ...
    80004c40:	f6040593          	addi	a1,s0,-160
    ...
    80004c52:	f6040513          	addi	a0,s0,-160
...
sys_exec(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80004cda:	f5040593          	addi	a1,s0,-176
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80004cee:	e4840593          	addi	a1,s0,-440
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80004d22:	e4040593          	addi	a1,s0,-448
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80004d68:	f5040913          	addi	s2,s0,-176
  ...
  return -1;
    ...
    80004d88:	fd078793          	addi	a5,a5,-48
    80004d8c:	97a2                	add	a5,a5,s0
    80004d8e:	e807b023          	sd	zero,-384(a5)
  int ret = exec(path, argv);
    80004d92:	e5040593          	addi	a1,s0,-432
  ...
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80004da4:	f5040993          	addi	s3,s0,-176
...
sys_pipe(void)
{
  ...
  if(pipealloc(&rf, &wf) < 0)
    80004df8:	fc840593          	addi	a1,s0,-56
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    80004e3c:	fc440613          	addi	a2,s0,-60
    ...
    80004e54:	fc040613          	addi	a2,s0,-64
    80004e58:	fd843583          	ld	a1,-40(s0)
    80004e5c:	0591                	addi	a1,a1,4
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    80004edc:	6121                	addi	sp,sp,64
    80004ede:	8082                	ret

0000000080004ee0 <kernelvec>:
    80004ee0:	7111                	addi	sp,sp,-256
    ...
    80004f20:	e0ffc0ef          	jal	ra,80001d2e <kerneltrap>
...
plicinithart(void)
{
  ...
  *(uint32*)PLIC_SENABLE(hart)= (1 << UART0_IRQ) | (1 << VIRTIO0_IRQ);
    80004fc0:	0085171b          	slliw	a4,a0,0x8
  ...
  *(uint32*)PLIC_SPRIORITY(hart) = 0;
    80004fd2:	00d5151b          	slliw	a0,a0,0xd
...
plic_claim(void)
{
  ...
  int irq = *(uint32*)PLIC_SCLAIM(hart);
    80004ff8:	00d5151b          	slliw	a0,a0,0xd
...
plic_complete(int irq)
{
  ...
  *(uint32*)PLIC_SCLAIM(hart) = irq;
    80005020:	00d5151b          	slliw	a0,a0,0xd
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    80005048:	fbc70713          	addi	a4,a4,-68 # 8001b000 <disk>
    ...
    panic("free_desc 2");
  disk.desc[i].addr = 0;
    80005058:	00451793          	slli	a5,a0,0x4
    8000505c:	00018717          	auipc	a4,0x18
    80005060:	fa470713          	addi	a4,a4,-92 # 8001d000 <disk+0x2000>
  ...
  disk.free[i] = 1;
    ...
    80005088:	f7c70713          	addi	a4,a4,-132 # 8001b000 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    8000509c:	f8050513          	addi	a0,a0,-128 # 8001d018 <disk+0x2018>
    ...
    800050ac:	0141                	addi	sp,sp,16
    800050ae:	8082                	ret
    panic("free_desc 1");
    800050b0:	00003517          	auipc	a0,0x3
    800050b4:	63850513          	addi	a0,a0,1592 # 800086e8 <syscalls+0x320>
    800050b8:	00001097          	auipc	ra,0x1
    800050bc:	9c2080e7          	jalr	-1598(ra) # 80005a7a <panic>
    panic("free_desc 2");
    800050c0:	00003517          	auipc	a0,0x3
    800050c4:	63850513          	addi	a0,a0,1592 # 800086f8 <syscalls+0x330>
...
00000000800050d0 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    800050de:	62e58593          	addi	a1,a1,1582 # 80008708 <syscalls+0x340>
    800050e2:	00018517          	auipc	a0,0x18
    800050e6:	04650513          	addi	a0,a0,70 # 8001d128 <disk+0x2128>
  ...
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    ...
    800050fe:	97678793          	addi	a5,a5,-1674 # 74726976 <_entry-0xb8d968a>
  ...
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    ...
    8000512e:	55178793          	addi	a5,a5,1361 # 554d4551 <_entry-0x2ab2baaf>
  ...
  *R(VIRTIO_MMIO_DRIVER_FEATURES) = features;
    ...
    80005148:	75f68693          	addi	a3,a3,1887 # ffffffffc7ffe75f <end+0xffffffff47fd851f>
...
virtio_disk_rw(struct buf *b, int write)
{
    ...
    8000522c:	1880                	addi	s0,sp,112
    8000522e:	8a2a                	mv	s4,a0
    80005230:	8cae                	mv	s9,a1
  uint64 sector = b->blockno * (BSIZE / 512);
    80005232:	00c52c03          	lw	s8,12(a0)
    80005236:	001c1c1b          	slliw	s8,s8,0x1
    8000523a:	1c02                	slli	s8,s8,0x20
    8000523c:	020c5c13          	srli	s8,s8,0x20

  acquire(&disk.vdisk_lock);
    80005240:	00018517          	auipc	a0,0x18
    80005244:	ee850513          	addi	a0,a0,-280 # 8001d128 <disk+0x2128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005258:	dacb8b93          	addi	s7,s7,-596 # 8001b000 <disk>
  ...
  for(int i = 0; i < 3; i++){
    80005272:	2605                	addiw	a2,a2,1 # 2001 <_entry-0x7fffdfff>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005280:	d9c70713          	addi	a4,a4,-612 # 8001d018 <disk+0x2018>
    80005284:	87ca                	mv	a5,s2
    if(disk.free[i]){
    80005286:	00074683          	lbu	a3,0(a4)
    8000528a:	fee1                	bnez	a3,80005262 <virtio_disk_rw+0x50>
  for(int i = 0; i < NUM; i++){
    8000528c:	2785                	addiw	a5,a5,1
    8000528e:	0705                	addi	a4,a4,1
  ...
  while(1){
    ...
    800052b8:	e7458593          	addi	a1,a1,-396 # 8001d128 <disk+0x2128>
    800052bc:	00018517          	auipc	a0,0x18
    800052c0:	d5c50513          	addi	a0,a0,-676 # 8001d018 <disk+0x2018>
    800052c4:	ffffc097          	auipc	ra,0xffffc
    800052c8:	242080e7          	jalr	578(ra) # 80001506 <sleep>
  for(int i = 0; i < 3; i++){
    800052cc:	f9040993          	addi	s3,s0,-112
{
  ...
  disk.desc[idx[1]].flags |= VRING_DESC_F_NEXT;
    ...
    800052e8:	d1c80813          	addi	a6,a6,-740 # 8001b000 <disk>
    800052ec:	00018697          	auipc	a3,0x18
    800052f0:	d1468693          	addi	a3,a3,-748 # 8001d000 <disk+0x2000>
    800052f4:	6290                	ld	a2,0(a3)
    800052f6:	963a                	add	a2,a2,a4
    800052f8:	00c65583          	lhu	a1,12(a2)
    800052fc:	0015e593          	ori	a1,a1,1
  ...
  disk.avail->ring[disk.avail->idx % NUM] = idx[0];
    ...
    80005356:	8b9d                	andi	a5,a5,7
    80005358:	0786                	slli	a5,a5,0x1
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80005388:	da490913          	addi	s2,s2,-604 # 8001d128 <disk+0x2128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    800053a6:	20090713          	addi	a4,s2,512
    800053aa:	0712                	slli	a4,a4,0x4
    800053ac:	00016797          	auipc	a5,0x16
    800053b0:	c5478793          	addi	a5,a5,-940 # 8001b000 <disk>
    800053b4:	97ba                	add	a5,a5,a4
    800053b6:	0207b423          	sd	zero,40(a5)
    int flag = disk.desc[i].flags;
    800053ba:	00018997          	auipc	s3,0x18
    800053be:	c4698993          	addi	s3,s3,-954 # 8001d000 <disk+0x2000>
  ...
  release(&disk.vdisk_lock);
    ...
    8000540a:	6165                	addi	sp,sp,112
    8000540c:	8082                	ret
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    8000540e:	f9042503          	lw	a0,-112(s0)
    80005412:	20050793          	addi	a5,a0,512
    80005416:	0792                	slli	a5,a5,0x4
  if(write)
    80005418:	00016817          	auipc	a6,0x16
    8000541c:	be880813          	addi	a6,a6,-1048 # 8001b000 <disk>
  ...
  disk.desc[idx[0]].addr = (uint64) buf0;
    ...
    8000543c:	bc868693          	addi	a3,a3,-1080 # 8001d000 <disk+0x2000>
    80005440:	6298                	ld	a4,0(a3)
    80005442:	9732                	add	a4,a4,a2
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    80005444:	0a878593          	addi	a1,a5,168
  ...
  disk.desc[idx[1]].addr = (uint64) b->data;
    8000546a:	0712                	slli	a4,a4,0x4
    8000546c:	6290                	ld	a2,0(a3)
    8000546e:	963a                	add	a2,a2,a4
    80005470:	058a0593          	addi	a1,s4,88
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800054a6:	c8650513          	addi	a0,a0,-890 # 8001d128 <disk+0x2128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    800054c4:	b4078793          	addi	a5,a5,-1216 # 8001d000 <disk+0x2000>
    ...
    80005506:	20078793          	addi	a5,a5,512
    8000550a:	0792                	slli	a5,a5,0x4
    ...
    80005522:	17c2                	slli	a5,a5,0x30
    80005524:	93c1                	srli	a5,a5,0x30
  ...
  release(&disk.vdisk_lock);
    ...
    80005554:	22850513          	addi	a0,a0,552 # 80008778 <syscalls+0x3b0>
...
timerinit()
{
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
    8000556e:	0037979b          	slliw	a5,a5,0x3
    ...
    80005584:	24060613          	addi	a2,a2,576 # f4240 <_entry-0x7ff0bdc0>
  ...
  uint64 *scratch = &timer_scratch[id][0];
    8000558c:	00259693          	slli	a3,a1,0x2
    80005590:	96ae                	add	a3,a3,a1
    80005592:	068e                	slli	a3,a3,0x3
    80005594:	00019717          	auipc	a4,0x19
    80005598:	a6c70713          	addi	a4,a4,-1428 # 8001e000 <timer_scratch>
  ...
  asm volatile("csrw mtvec, %0" : : "r" (x));
    ...
    800055aa:	9ca78793          	addi	a5,a5,-1590 # 80004f70 <timervec>
  ...
  w_mie(r_mie() | MIE_MTIE);
    800055c2:	0807e793          	ori	a5,a5,128
...
00000000800055d0 <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    800055de:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffd85bf>
    800055e2:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
    800055e4:	6705                	lui	a4,0x1
    800055e6:	80070713          	addi	a4,a4,-2048 # 800 <_entry-0x7ffff800>
    800055ea:	8fd9                	or	a5,a5,a4
  asm volatile("csrw mstatus, %0" : : "r" (x));
    800055ec:	30079073          	csrw	mstatus,a5
  asm volatile("csrw mepc, %0" : : "r" (x));
    800055f0:	ffffb797          	auipc	a5,0xffffb
    800055f4:	d2e78793          	addi	a5,a5,-722 # 8000031e <main>
  ...
  asm volatile("csrw medeleg, %0" : : "r" (x));
    ...
    80005604:	17fd                	addi	a5,a5,-1 # ffff <_entry-0x7fff0001>
...
consolewrite(int user_src, uint64 src, int n)
{
  ...
  for(i = 0; i < n; i++){
    ...
    8000566a:	fbf40513          	addi	a0,s0,-65
  ...
  for(i = 0; i < n; i++){
    80005686:	2905                	addiw	s2,s2,1
    80005688:	0485                	addi	s1,s1,1
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    800056cc:	a7850513          	addi	a0,a0,-1416 # 80026140 <cons>
  ...
  while(n > 0){
    ...
    800056dc:	a6848493          	addi	s1,s1,-1432 # 80026140 <cons>
      if(myproc()->killed){
        release(&cons.lock);
        return -1;
      }
    ...
    800056e4:	af890913          	addi	s2,s2,-1288 # 800261d8 <cons+0x98>
  while(n > 0){
    ...
    80005720:	a2470713          	addi	a4,a4,-1500 # 80026140 <cons>
    80005724:	0017869b          	addiw	a3,a5,1
    80005728:	08d72c23          	sw	a3,152(a4)
    8000572c:	07f7f693          	andi	a3,a5,127
    ...
    80005746:	faf40613          	addi	a2,s0,-81
    ...
    dst++;
    8000575c:	0a05                	addi	s4,s4,1
    --n;
    8000575e:	39fd                	addiw	s3,s3,-1
  ...
  return target - n;
    ...
    80005780:	9c450513          	addi	a0,a0,-1596 # 80026140 <cons>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    8000580a:	93a50513          	addi	a0,a0,-1734 # 80026140 <cons>
  ...
  release(&cons.lock);
    ...
    80005838:	90c50513          	addi	a0,a0,-1780 # 80026140 <cons>
  ...
  switch(c){
    ...
    8000585c:	8e870713          	addi	a4,a4,-1816 # 80026140 <cons>
    ...
    80005886:	8be78793          	addi	a5,a5,-1858 # 80026140 <cons>
    8000588a:	0a07a703          	lw	a4,160(a5)
    8000588e:	0017069b          	addiw	a3,a4,1
    80005892:	0006861b          	sext.w	a2,a3
    80005896:	0ad7a023          	sw	a3,160(a5)
    8000589a:	07f77713          	andi	a4,a4,127
    ...
    800058b8:	0807879b          	addiw	a5,a5,128
    ...
    80005914:	83070713          	addi	a4,a4,-2000 # 80026140 <cons>
    ...
    80005950:	7f478793          	addi	a5,a5,2036 # 80026140 <cons>
    80005954:	0a07a703          	lw	a4,160(a5)
    80005958:	0017069b          	addiw	a3,a4,1
    8000595c:	0006861b          	sext.w	a2,a3
    80005960:	0ad7a023          	sw	a3,160(a5)
    80005964:	07f77713          	andi	a4,a4,127
    ...
    8000597c:	86050513          	addi	a0,a0,-1952 # 800261d8 <cons+0x98>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80005996:	dfe58593          	addi	a1,a1,-514 # 80008790 <syscalls+0x3c8>
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    800059b6:	71678793          	addi	a5,a5,1814 # 800190c8 <devsw>
    800059ba:	00000717          	auipc	a4,0x0
    800059be:	cee70713          	addi	a4,a4,-786 # 800056a8 <consoleread>
    800059c2:	eb98                	sd	a4,16(a5)
  devsw[CONSOLE].write = consolewrite;
    800059c4:	00000717          	auipc	a4,0x0
    800059c8:	c8070713          	addi	a4,a4,-896 # 80005644 <consolewrite>
...
printint(int xx, int base, int sign)
{
  ...
  if(sign && (sign = xx < 0))
    ...
    800059ec:	fd040693          	addi	a3,s0,-48
  ...
  do {
    ...
    800059f8:	dcc60613          	addi	a2,a2,-564 # 800087c0 <digits>
    800059fc:	883a                	mv	a6,a4
    800059fe:	2705                	addiw	a4,a4,1
    80005a00:	02b577bb          	remuw	a5,a0,a1
    80005a04:	1782                	slli	a5,a5,0x20
    80005a06:	9381                	srli	a5,a5,0x20
...
panic(char *s)
{
  ...
  printf("panic: ");
    ...
    80005a92:	d0a50513          	addi	a0,a0,-758 # 80008798 <syscalls+0x3d0>
  ...
  printf("\n");
    ...
    80005aac:	5a050513          	addi	a0,a0,1440 # 80008048 <etext+0x48>
...
0000000080005ac4 <printf>:
{
  ...
  va_start(ap, fmt);
    80005b06:	00840793          	addi	a5,s0,8
  ...
  consputc('x');
    ...
    80005b26:	c9eb0b13          	addi	s6,s6,-866 # 800087c0 <digits>
    switch(c){
    ...
    80005b38:	6b450513          	addi	a0,a0,1716 # 800261e8 <pr>
    ...
    80005b4a:	c6250513          	addi	a0,a0,-926 # 800087a8 <syscalls+0x3e0>
  ...
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    ...
    80005b98:	00878713          	addi	a4,a5,8
    ...
    80005bbc:	00878713          	addi	a4,a5,8
  ...
  consputc('x');
    ...
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80005bfe:	03c95793          	srli	a5,s2,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    80005c44:	b6048493          	addi	s1,s1,-1184 # 800087a0 <syscalls+0x3d8>
      for(; *s; s++)
  ...
  if(locking)
    ...
    80005c96:	55650513          	addi	a0,a0,1366 # 800261e8 <pr>
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    ...
    80005cb2:	53a48493          	addi	s1,s1,1338 # 800261e8 <pr>
    80005cb6:	00003597          	auipc	a1,0x3
    80005cba:	b0258593          	addi	a1,a1,-1278 # 800087b8 <syscalls+0x3f0>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    80005d0a:	ad258593          	addi	a1,a1,-1326 # 800087d8 <digits+0x18>
    80005d0e:	00020517          	auipc	a0,0x20
    80005d12:	4fa50513          	addi	a0,a0,1274 # 80026208 <uart_tx_lock>
...
uartputc_sync(int c)
{
  ...
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    ...
    80005d4e:	0207f793          	andi	a5,a5,32
    ...
    80005d82:	06f70a63          	beq	a4,a5,80005df6 <uartstart+0x84>
{
    ...
    80005da0:	46ca0a13          	addi	s4,s4,1132 # 80026208 <uart_tx_lock>
    uart_tx_r += 1;
    80005da4:	00003497          	auipc	s1,0x3
    80005da8:	27c48493          	addi	s1,s1,636 # 80009020 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80005dac:	00003997          	auipc	s3,0x3
    80005db0:	27c98993          	addi	s3,s3,636 # 80009028 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    ...
    int c = uart_tx_buf[uart_tx_r % UART_TX_BUF_SIZE];
    80005dbe:	01f7f713          	andi	a4,a5,31
    80005dc2:	9752                	add	a4,a4,s4
    80005dc4:	01874a83          	lbu	s5,24(a4)
    uart_tx_r += 1;
    80005dc8:	0785                	addi	a5,a5,1
...
0000000080005df8 <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    ...
    80005e0e:	3fe50513          	addi	a0,a0,1022 # 80026208 <uart_tx_lock>
  ...
  if(panicked){
    ...
    80005e36:	02078793          	addi	a5,a5,32
    80005e3a:	02e79b63          	bne	a5,a4,80005e70 <uartputc+0x78>
      sleep(&uart_tx_r, &uart_tx_lock);
    80005e3e:	00020997          	auipc	s3,0x20
    80005e42:	3ca98993          	addi	s3,s3,970 # 80026208 <uart_tx_lock>
    80005e46:	00003497          	auipc	s1,0x3
    80005e4a:	1da48493          	addi	s1,s1,474 # 80009020 <uart_tx_r>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80005e4e:	00003917          	auipc	s2,0x3
    80005e52:	1da90913          	addi	s2,s2,474 # 80009028 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
    ...
    80005e74:	39848493          	addi	s1,s1,920 # 80026208 <uart_tx_lock>
    80005e78:	01f77793          	andi	a5,a4,31
    80005e7c:	97a6                	add	a5,a5,s1
    80005e7e:	01478c23          	sb	s4,24(a5)
      uart_tx_w += 1;
    80005e82:	0705                	addi	a4,a4,1
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    80005ef8:	31448493          	addi	s1,s1,788 # 80026208 <uart_tx_lock>
...
push_off(void)
{
  ...
  return (x & SSTATUS_SIE) != 0;
    80005faa:	8085                	srli	s1,s1,0x1
    80005fac:	8885                	andi	s1,s1,1
...
0000000080005fb2 <acquire>:
{
  ...
  lk->cpu = mycpu();
    ...
    80005ffa:	7ea50513          	addi	a0,a0,2026 # 800087e0 <digits+0x20>
...
pop_off(void)
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000604a:	7a250513          	addi	a0,a0,1954 # 800087e8 <digits+0x28>
    8000604e:	00000097          	auipc	ra,0x0
    80006052:	a2c080e7          	jalr	-1492(ra) # 80005a7a <panic>
    panic("pop_off");
    80006056:	00002517          	auipc	a0,0x2
    8000605a:	7aa50513          	addi	a0,a0,1962 # 80008800 <digits+0x40>
...
0000000080006066 <release>:
{
  ...
  pop_off();
    ...
    800060a2:	76a50513          	addi	a0,a0,1898 # 80008808 <digits+0x48>
