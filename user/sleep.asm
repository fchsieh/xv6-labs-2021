...
int main(int argc, char *argv[]) {
  ...
  2e:	78e50513          	addi	a0,a0,1934 # 7b8 <malloc+0xe8>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49c:	34070713          	addi	a4,a4,832 # 7d8 <malloc+0x108>
 ...
 57a:	25a90913          	addi	s2,s2,602 # 7d0 <malloc+0x100>
        while(*s != 0){
 ...
 684:	00e6ea63          	bltu	a3,a4,698 <free+0x4a>
{
 ...
 6c6:	18f73323          	sd	a5,390(a4) # 848 <freep>
}
 6ca:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6f8:	15453503          	ld	a0,340(a0) # 848 <freep>
 ...
 720:	12c90913          	addi	s2,s2,300 # 848 <freep>
  if(p == (char*)-1)
 724:	5afd                	li	s5,-1
 726:	a895                	j	79a <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 728:	00000797          	auipc	a5,0x0
 72c:	12878793          	addi	a5,a5,296 # 850 <base>
 730:	00000717          	auipc	a4,0x0
 734:	10f73c23          	sd	a5,280(a4) # 848 <freep>
 738:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 75c:	0ea73823          	sd	a0,240(a4) # 848 <freep>
      return (void*)(p + 1);
