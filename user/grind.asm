...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	26650513          	addi	a0,a0,614 # 1300 <malloc+0xe8>
      a2:	00001097          	auipc	ra,0x1
      a6:	dbe080e7          	jalr	-578(ra) # e60 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	25650513          	addi	a0,a0,598 # 1300 <malloc+0xe8>
      b2:	00001097          	auipc	ra,0x1
      b6:	db6080e7          	jalr	-586(ra) # e68 <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	24c50513          	addi	a0,a0,588 # 1308 <malloc+0xf0>
  ...
  chdir("/");
      ...
      da:	25250513          	addi	a0,a0,594 # 1328 <malloc+0x110>
      de:	00001097          	auipc	ra,0x1
      e2:	d8a080e7          	jalr	-630(ra) # e68 <chdir>
      e6:	00001997          	auipc	s3,0x1
      ea:	25298993          	addi	s3,s3,594 # 1338 <malloc+0x120>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	24098993          	addi	s3,s3,576 # 1330 <malloc+0x118>
  uint64 iters = 0;
      f8:	4481                	li	s1,0
  int fd = -1;
      fa:	5a7d                	li	s4,-1
      fc:	00001917          	auipc	s2,0x1
     100:	4ec90913          	addi	s2,s2,1260 # 15e8 <malloc+0x3d0>
    ...
    if(what == 1){
     ...
     10e:	23650513          	addi	a0,a0,566 # 1340 <malloc+0x128>
    ...
    if(what == 1){
     ...
     168:	1ec50513          	addi	a0,a0,492 # 1350 <malloc+0x138>
     ...
     182:	1c250513          	addi	a0,a0,450 # 1340 <malloc+0x128>
     ...
     194:	17050513          	addi	a0,a0,368 # 1300 <malloc+0xe8>
     ...
     1a6:	1c650513          	addi	a0,a0,454 # 1368 <malloc+0x150>
     1aa:	00001097          	auipc	ra,0x1
     1ae:	c9e080e7          	jalr	-866(ra) # e48 <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	17650513          	addi	a0,a0,374 # 1328 <malloc+0x110>
     1ba:	00001097          	auipc	ra,0x1
     1be:	cae080e7          	jalr	-850(ra) # e68 <chdir>
     1c2:	b785                	j	122 <go+0xaa>
        printf("grind: chdir grindir failed\n");
     1c4:	00001517          	auipc	a0,0x1
     1c8:	14450513          	addi	a0,a0,324 # 1308 <malloc+0xf0>
     ...
     1f0:	18450513          	addi	a0,a0,388 # 1370 <malloc+0x158>
     ...
     212:	17250513          	addi	a0,a0,370 # 1380 <malloc+0x168>
     ...
     22a:	4aa58593          	addi	a1,a1,1194 # 16d0 <buf.0>
     22e:	8552                	mv	a0,s4
     ...
     242:	49258593          	addi	a1,a1,1170 # 16d0 <buf.0>
     246:	8552                	mv	a0,s4
     ...
     256:	0ee50513          	addi	a0,a0,238 # 1340 <malloc+0x128>
     25a:	00001097          	auipc	ra,0x1
     25e:	c06080e7          	jalr	-1018(ra) # e60 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     262:	20200593          	li	a1,514
     266:	00001517          	auipc	a0,0x1
     26a:	13250513          	addi	a0,a0,306 # 1398 <malloc+0x180>
     ...
     282:	12a50513          	addi	a0,a0,298 # 13a8 <malloc+0x190>
     ...
     294:	12050513          	addi	a0,a0,288 # 13b0 <malloc+0x198>
     298:	00001097          	auipc	ra,0x1
     29c:	bc8080e7          	jalr	-1080(ra) # e60 <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     2a0:	20200593          	li	a1,514
     2a4:	00001517          	auipc	a0,0x1
     2a8:	11450513          	addi	a0,a0,276 # 13b8 <malloc+0x1a0>
     ...
     2c0:	10c50513          	addi	a0,a0,268 # 13c8 <malloc+0x1b0>
     ...
     2d2:	0c250513          	addi	a0,a0,194 # 1390 <malloc+0x178>
     2d6:	00001097          	auipc	ra,0x1
     2da:	b72080e7          	jalr	-1166(ra) # e48 <unlink>
      link("../grindir/./../a", "../b");
     2de:	00001597          	auipc	a1,0x1
     2e2:	08a58593          	addi	a1,a1,138 # 1368 <malloc+0x150>
     2e6:	00001517          	auipc	a0,0x1
     2ea:	0ea50513          	addi	a0,a0,234 # 13d0 <malloc+0x1b8>
     ...
     2fc:	0f050513          	addi	a0,a0,240 # 13e8 <malloc+0x1d0>
     300:	00001097          	auipc	ra,0x1
     304:	b48080e7          	jalr	-1208(ra) # e48 <unlink>
      link(".././b", "/grindir/../a");
     308:	00001597          	auipc	a1,0x1
     30c:	06858593          	addi	a1,a1,104 # 1370 <malloc+0x158>
     310:	00001517          	auipc	a0,0x1
     314:	0e850513          	addi	a0,a0,232 # 13f8 <malloc+0x1e0>
     ...
     348:	0bc50513          	addi	a0,a0,188 # 1400 <malloc+0x1e8>
     ...
     396:	06e50513          	addi	a0,a0,110 # 1400 <malloc+0x1e8>
     ...
     3a8:	a54080e7          	jalr	-1452(ra) # df8 <exit>
      ...
      sbrk(6011);
     3ac:	6505                	lui	a0,0x1
     3ae:	77b50513          	addi	a0,a0,1915 # 177b <buf.0+0xab>
     ...
     3f6:	02650513          	addi	a0,a0,38 # 1418 <malloc+0x200>
     ...
     422:	fc250513          	addi	a0,a0,-62 # 13e0 <malloc+0x1c8>
     ...
     444:	fc050513          	addi	a0,a0,-64 # 1400 <malloc+0x1e8>
     ...
     45e:	fce50513          	addi	a0,a0,-50 # 1428 <malloc+0x210>
     ...
     4ac:	f5850513          	addi	a0,a0,-168 # 1400 <malloc+0x1e8>
     ...
     508:	f3c50513          	addi	a0,a0,-196 # 1440 <malloc+0x228>
     ...
     534:	f2858593          	addi	a1,a1,-216 # 1458 <malloc+0x240>
     ...
     636:	dce50513          	addi	a0,a0,-562 # 1400 <malloc+0x1e8>
     ...
     650:	e5450513          	addi	a0,a0,-428 # 14a0 <malloc+0x288>
     ...
     664:	e4050513          	addi	a0,a0,-448 # 14a0 <malloc+0x288>
     ...
     67c:	de058593          	addi	a1,a1,-544 # 1458 <malloc+0x240>
     ...
     6c2:	de250513          	addi	a0,a0,-542 # 14a0 <malloc+0x288>
     6c6:	00000097          	auipc	ra,0x0
     6ca:	782080e7          	jalr	1922(ra) # e48 <unlink>
     6ce:	bc91                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     6d0:	00001517          	auipc	a0,0x1
     6d4:	dd850513          	addi	a0,a0,-552 # 14a8 <malloc+0x290>
     ...
     6ee:	dd650513          	addi	a0,a0,-554 # 14c0 <malloc+0x2a8>
     ...
     708:	dd450513          	addi	a0,a0,-556 # 14d8 <malloc+0x2c0>
     ...
     724:	dd050513          	addi	a0,a0,-560 # 14f0 <malloc+0x2d8>
     ...
     73e:	dde50513          	addi	a0,a0,-546 # 1518 <malloc+0x300>
     ...
     826:	d9658593          	addi	a1,a1,-618 # 15b8 <malloc+0x3a0>
     ...
     84a:	d7a50513          	addi	a0,a0,-646 # 15c0 <malloc+0x3a8>
     ...
     864:	be058593          	addi	a1,a1,-1056 # 1440 <malloc+0x228>
     868:	4509                	li	a0,2
     ...
     880:	bc458593          	addi	a1,a1,-1084 # 1440 <malloc+0x228>
     884:	4509                	li	a0,2
     ...
     8dc:	c6858593          	addi	a1,a1,-920 # 1540 <malloc+0x328>
     8e0:	4509                	li	a0,2
     ...
     950:	ab458593          	addi	a1,a1,-1356 # 1400 <malloc+0x1e8>
     954:	4509                	li	a0,2
     ...
     99c:	ba858593          	addi	a1,a1,-1112 # 1540 <malloc+0x328>
     9a0:	4509                	li	a0,2
     ...
     9e0:	b6458593          	addi	a1,a1,-1180 # 1540 <malloc+0x328>
     9e4:	4509                	li	a0,2
     ...
     a48:	9bc58593          	addi	a1,a1,-1604 # 1400 <malloc+0x1e8>
     a4c:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a70:	97450513          	addi	a0,a0,-1676 # 13e0 <malloc+0x1c8>
     a74:	00000097          	auipc	ra,0x0
     a78:	3d4080e7          	jalr	980(ra) # e48 <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	91450513          	addi	a0,a0,-1772 # 1390 <malloc+0x178>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     ab4:	95050513          	addi	a0,a0,-1712 # 1400 <malloc+0x1e8>
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     ada:	6789                	lui	a5,0x2
     adc:	c0978793          	addi	a5,a5,-1015 # 1c09 <__BSS_END__+0x141>
    ...
    printf("grind: fork failed\n");
     ...
     af6:	90e50513          	addi	a0,a0,-1778 # 1400 <malloc+0x1e8>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ee0:	7cc50513          	addi	a0,a0,1996 # 16a8 <digits>
     ee4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fe4:	67070713          	addi	a4,a4,1648 # 1650 <malloc+0x438>
  ...
  putc(fd, 'x');
    ...
    106e:	63eb8b93          	addi	s7,s7,1598 # 16a8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10c2:	58a90913          	addi	s2,s2,1418 # 1648 <malloc+0x430>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1268:	46490913          	addi	s2,s2,1124 # 16c8 <freep>
  if(p == (char*)-1)
    126c:	5afd                	li	s5,-1
    126e:	a895                	j	12e2 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    1270:	00001797          	auipc	a5,0x1
    1274:	84878793          	addi	a5,a5,-1976 # 1ab8 <base>
