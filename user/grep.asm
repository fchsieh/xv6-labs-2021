...
000000000000011a <grep>:
{
 ...
 140:	99ca8a93          	addi	s5,s5,-1636 # ad8 <buf>
 ...
 1ba:	92250513          	addi	a0,a0,-1758 # ad8 <buf>
...
00000000000001ec <main>:
{
 ...
 25e:	7c658593          	addi	a1,a1,1990 # a20 <malloc+0xea>
 262:	4509                	li	a0,2
 ...
 294:	7b050513          	addi	a0,a0,1968 # a40 <malloc+0x10a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5fe:	4be50513          	addi	a0,a0,1214 # ab8 <digits>
 602:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 702:	36270713          	addi	a4,a4,866 # a60 <malloc+0x12a>
 ...
 78c:	330b8b93          	addi	s7,s7,816 # ab8 <digits>
 ...
 7e0:	27c90913          	addi	s2,s2,636 # a58 <malloc+0x122>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 986:	14e90913          	addi	s2,s2,334 # ad0 <freep>
  if(p == (char*)-1)
 98a:	5afd                	li	s5,-1
 98c:	a895                	j	a00 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 98e:	00000797          	auipc	a5,0x0
 992:	54a78793          	addi	a5,a5,1354 # ed8 <base>
