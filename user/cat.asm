...
cat(int fd)
{
  ...
  44:	85058593          	addi	a1,a1,-1968 # 890 <malloc+0xe8>
  48:	4509                	li	a0,2
  ...
  72:	83a58593          	addi	a1,a1,-1990 # 8a8 <malloc+0x100>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 104:	7c058593          	addi	a1,a1,1984 # 8c0 <malloc+0x118>
 108:	4509                	li	a0,2
...
malloc(uint nbytes)
{
 ...
 804:	35878793          	addi	a5,a5,856 # b58 <base>
