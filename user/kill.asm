...
main(int argc, char **argv)
{
  ...
  4c:	79058593          	addi	a1,a1,1936 # 7d8 <malloc+0xe8>
  50:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4bc:	34070713          	addi	a4,a4,832 # 7f8 <malloc+0x108>
 ...
 59a:	25a90913          	addi	s2,s2,602 # 7f0 <malloc+0x100>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 740:	12c90913          	addi	s2,s2,300 # 868 <freep>
  if(p == (char*)-1)
 744:	5afd                	li	s5,-1
 746:	a895                	j	7ba <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 748:	00000797          	auipc	a5,0x0
 74c:	12878793          	addi	a5,a5,296 # 870 <base>
