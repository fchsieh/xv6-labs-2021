...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	cfa50513          	addi	a0,a0,-774 # 5d38 <malloc+0xe6>
      ...
      74:	8082                	ret
{
      ...
      84:	cd850513          	addi	a0,a0,-808 # 5d58 <malloc+0x106>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	cc850513          	addi	a0,a0,-824 # 5d70 <malloc+0x11e>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	cca50513          	addi	a0,a0,-822 # 5d90 <malloc+0x13e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	c9250513          	addi	a0,a0,-878 # 5d78 <malloc+0x126>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	c9e50513          	addi	a0,a0,-866 # 5da0 <malloc+0x14e>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	c9c50513          	addi	a0,a0,-868 # 5dc8 <malloc+0x176>
     134:	00005097          	auipc	ra,0x5
     138:	74e080e7          	jalr	1870(ra) # 5882 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	c8850513          	addi	a0,a0,-888 # 5dc8 <malloc+0x176>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	c8458593          	addi	a1,a1,-892 # 5dd8 <malloc+0x186>
     15c:	00005097          	auipc	ra,0x5
     160:	6f6080e7          	jalr	1782(ra) # 5852 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	c6050513          	addi	a0,a0,-928 # 5dc8 <malloc+0x176>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	c6458593          	addi	a1,a1,-924 # 5de0 <malloc+0x18e>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	c3450513          	addi	a0,a0,-972 # 5dc8 <malloc+0x176>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	c1e50513          	addi	a0,a0,-994 # 5de8 <malloc+0x196>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	b9450513          	addi	a0,a0,-1132 # 5e10 <malloc+0x1be>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	b80a8a93          	addi	s5,s5,-1152 # 5e10 <malloc+0x1be>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	b0e50513          	addi	a0,a0,-1266 # 5e20 <malloc+0x1ce>
     ...
     338:	b0c50513          	addi	a0,a0,-1268 # 5e40 <malloc+0x1ee>
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	ae8a0a13          	addi	s4,s4,-1304 # 5e58 <malloc+0x206>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	a4450513          	addi	a0,a0,-1468 # 5e60 <malloc+0x20e>
     ...
     43e:	a3e50513          	addi	a0,a0,-1474 # 5e78 <malloc+0x226>
     ...
     45c:	a5050513          	addi	a0,a0,-1456 # 5ea8 <malloc+0x256>
     ...
     476:	a6650513          	addi	a0,a0,-1434 # 5ed8 <malloc+0x286>
     ...
     494:	a5850513          	addi	a0,a0,-1448 # 5ee8 <malloc+0x296>
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	a4aa0a13          	addi	s4,s4,-1462 # 5f18 <malloc+0x2c6>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	90aa8a93          	addi	s5,s5,-1782 # 5de0 <malloc+0x18e>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	9a450513          	addi	a0,a0,-1628 # 5f20 <malloc+0x2ce>
     ...
     59e:	99e50513          	addi	a0,a0,-1634 # 5f38 <malloc+0x2e6>
     ...
     5b8:	92450513          	addi	a0,a0,-1756 # 5ed8 <malloc+0x286>
     ...
     5d2:	99a50513          	addi	a0,a0,-1638 # 5f68 <malloc+0x316>
     ...
     5f0:	99450513          	addi	a0,a0,-1644 # 5f80 <malloc+0x32e>
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	79658593          	addi	a1,a1,1942 # 5dd8 <malloc+0x186>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	76a50513          	addi	a0,a0,1898 # 5dc8 <malloc+0x176>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	73e50513          	addi	a0,a0,1854 # 5dc8 <malloc+0x176>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	72a50513          	addi	a0,a0,1834 # 5dc8 <malloc+0x176>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	93458593          	addi	a1,a1,-1740 # 6010 <malloc+0x3be>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	6aa50513          	addi	a0,a0,1706 # 5dc8 <malloc+0x176>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	84e50513          	addi	a0,a0,-1970 # 5fb0 <malloc+0x35e>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	85250513          	addi	a0,a0,-1966 # 5fd0 <malloc+0x37e>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     796:	84e50513          	addi	a0,a0,-1970 # 5fe0 <malloc+0x38e>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	85250513          	addi	a0,a0,-1966 # 6000 <malloc+0x3ae>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7c6:	81e50513          	addi	a0,a0,-2018 # 5fe0 <malloc+0x38e>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	83850513          	addi	a0,a0,-1992 # 6018 <malloc+0x3c6>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	83a50513          	addi	a0,a0,-1990 # 6038 <malloc+0x3e6>
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	82650513          	addi	a0,a0,-2010 # 6058 <malloc+0x406>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	83698993          	addi	s3,s3,-1994 # 6080 <malloc+0x42e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	866a8a93          	addi	s5,s5,-1946 # 60b8 <malloc+0x466>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	7c050513          	addi	a0,a0,1984 # 6058 <malloc+0x406>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	4fe58593          	addi	a1,a1,1278 # bdb0 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	78450513          	addi	a0,a0,1924 # 6058 <malloc+0x406>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	76250513          	addi	a0,a0,1890 # 6060 <malloc+0x40e>
    ...
    exit(1);
     ...
     920:	77450513          	addi	a0,a0,1908 # 6090 <malloc+0x43e>
     ...
     93e:	78e50513          	addi	a0,a0,1934 # 60c8 <malloc+0x476>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	79a50513          	addi	a0,a0,1946 # 60f0 <malloc+0x49e>
    ...
    printf("%s: read failed\n", s);
     ...
     976:	79e50513          	addi	a0,a0,1950 # 6110 <malloc+0x4be>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	79a50513          	addi	a0,a0,1946 # 6128 <malloc+0x4d6>
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	78850513          	addi	a0,a0,1928 # 6148 <malloc+0x4f6>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	3dc90913          	addi	s2,s2,988 # bdb0 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	73650513          	addi	a0,a0,1846 # 6148 <malloc+0x4f6>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	38a90913          	addi	s2,s2,906 # bdb0 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	6f650513          	addi	a0,a0,1782 # 6150 <malloc+0x4fe>
    ...
    exit(1);
     ...
     a7c:	6f850513          	addi	a0,a0,1784 # 6170 <malloc+0x51e>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	70450513          	addi	a0,a0,1796 # 6198 <malloc+0x546>
  ...
  if(unlink("big") < 0){
     ...
     ac4:	68850513          	addi	a0,a0,1672 # 6148 <malloc+0x4f6>
     ...
     af0:	6cc50513          	addi	a0,a0,1740 # 61b8 <malloc+0x566>
     ...
     b0e:	6d650513          	addi	a0,a0,1750 # 61e0 <malloc+0x58e>
     ...
     b2c:	6d050513          	addi	a0,a0,1744 # 61f8 <malloc+0x5a6>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	6dc50513          	addi	a0,a0,1756 # 6220 <malloc+0x5ce>
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	6c650513          	addi	a0,a0,1734 # 6238 <malloc+0x5e6>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	6de58593          	addi	a1,a1,1758 # 6268 <malloc+0x616>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	69250513          	addi	a0,a0,1682 # 6238 <malloc+0x5e6>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	67c50513          	addi	a0,a0,1660 # 6238 <malloc+0x5e6>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	66650513          	addi	a0,a0,1638 # 6238 <malloc+0x5e6>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	6ca58593          	addi	a1,a1,1738 # 62b0 <malloc+0x65e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	1ae58593          	addi	a1,a1,430 # bdb0 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  if(write(fd, buf, 10) != 10){
     ...
     c30:	18458593          	addi	a1,a1,388 # bdb0 <buf>
     c34:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	5ea50513          	addi	a0,a0,1514 # 6238 <malloc+0x5e6>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	5da50513          	addi	a0,a0,1498 # 6248 <malloc+0x5f6>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	5e650513          	addi	a0,a0,1510 # 6270 <malloc+0x61e>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	5ea50513          	addi	a0,a0,1514 # 6290 <malloc+0x63e>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	5f650513          	addi	a0,a0,1526 # 62b8 <malloc+0x666>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	5fa50513          	addi	a0,a0,1530 # 62d8 <malloc+0x686>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	5fe50513          	addi	a0,a0,1534 # 62f8 <malloc+0x6a6>
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	50a58593          	addi	a1,a1,1290 # 6268 <malloc+0x616>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	5a258593          	addi	a1,a1,1442 # 6320 <malloc+0x6ce>
     d86:	00005517          	auipc	a0,0x5
     d8a:	59250513          	addi	a0,a0,1426 # 6318 <malloc+0x6c6>
  ...
  unlink("lf1");
     ...
     d9e:	57e50513          	addi	a0,a0,1406 # 6318 <malloc+0x6c6>
     da2:	00005097          	auipc	ra,0x5
     da6:	ae0080e7          	jalr	-1312(ra) # 5882 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	56c50513          	addi	a0,a0,1388 # 6318 <malloc+0x6c6>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	55e50513          	addi	a0,a0,1374 # 6320 <malloc+0x6ce>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	fd658593          	addi	a1,a1,-42 # bdb0 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	52658593          	addi	a1,a1,1318 # 6320 <malloc+0x6ce>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	51050513          	addi	a0,a0,1296 # 6320 <malloc+0x6ce>
     e18:	00005097          	auipc	ra,0x5
     e1c:	a6a080e7          	jalr	-1430(ra) # 5882 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	4f858593          	addi	a1,a1,1272 # 6318 <malloc+0x6c6>
     e28:	00005517          	auipc	a0,0x5
     e2c:	4f850513          	addi	a0,a0,1272 # 6320 <malloc+0x6ce>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	4dc58593          	addi	a1,a1,1244 # 6318 <malloc+0x6c6>
     e44:	00005517          	auipc	a0,0x5
     e48:	5e450513          	addi	a0,a0,1508 # 6428 <malloc+0x7d6>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	4c250513          	addi	a0,a0,1218 # 6328 <malloc+0x6d6>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	4be50513          	addi	a0,a0,1214 # 6340 <malloc+0x6ee>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	4ba50513          	addi	a0,a0,1210 # 6358 <malloc+0x706>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	4be50513          	addi	a0,a0,1214 # 6378 <malloc+0x726>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	4d250513          	addi	a0,a0,1234 # 63a8 <malloc+0x756>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	4ce50513          	addi	a0,a0,1230 # 63c0 <malloc+0x76e>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	4ca50513          	addi	a0,a0,1226 # 63d8 <malloc+0x786>
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	4d650513          	addi	a0,a0,1238 # 6400 <malloc+0x7ae>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	4ea50513          	addi	a0,a0,1258 # 6430 <malloc+0x7de>
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	4a4a0a13          	addi	s4,s4,1188 # 6450 <malloc+0x7fe>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	45250513          	addi	a0,a0,1106 # 6450 <malloc+0x7fe>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	3ea50513          	addi	a0,a0,1002 # 6458 <malloc+0x806>
    ...
    1092:	3ea50513          	addi	a0,a0,1002 # 6478 <malloc+0x826>
    ...
    10ae:	3ee50513          	addi	a0,a0,1006 # 6498 <malloc+0x846>
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	3dc98993          	addi	s3,s3,988 # 64b8 <malloc+0x866>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	3b050513          	addi	a0,a0,944 # 64c8 <malloc+0x876>
...
badarg(char *s)
{
    ...
    117a:	35048493          	addi	s1,s1,848 # c350 <buf+0x5a0>
  for(int i = 0; i < 50000; i++){
    ...
    1188:	bec98993          	addi	s3,s3,-1044 # 5d70 <malloc+0x11e>
    argv[0] = (char*)0xffffffff;
...
00000000000011b0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1212:	4b278793          	addi	a5,a5,1202 # 76c0 <malloc+0x1a6e>
  ...
  if(pid == 0){
    ...
    1248:	45478793          	addi	a5,a5,1108 # 8698 <big.0>
    124c:	00008697          	auipc	a3,0x8
    1250:	44c68693          	addi	a3,a3,1100 # 9698 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    126e:	e9678793          	addi	a5,a5,-362 # 8100 <malloc+0x24ae>
    ...
    1292:	ae250513          	addi	a0,a0,-1310 # 5d70 <malloc+0x11e>
    ...
    12aa:	2ca50513          	addi	a0,a0,714 # 6570 <malloc+0x91e>
    ...
    12ca:	22250513          	addi	a0,a0,546 # 64e8 <malloc+0x896>
    ...
    12ea:	22250513          	addi	a0,a0,546 # 6508 <malloc+0x8b6>
    ...
    130c:	22050513          	addi	a0,a0,544 # 6528 <malloc+0x8d6>
    ...
    132c:	22850513          	addi	a0,a0,552 # 6550 <malloc+0x8fe>
    ...
    1346:	6a650513          	addi	a0,a0,1702 # 69e8 <malloc+0xd96>
  ...
  if(st != 747){
    ...
    1390:	20c50513          	addi	a0,a0,524 # 6598 <malloc+0x946>
...
00000000000013a6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c2:	a0a50513          	addi	a0,a0,-1526 # 5dc8 <malloc+0x176>
  ...
  if(pid == 0){
    ...
    13ec:	9e0a0a13          	addi	s4,s4,-1568 # 5dc8 <malloc+0x176>
      int n = write(fd, "1234567890", 10);
    13f0:	00005a97          	auipc	s5,0x5
    13f4:	208a8a93          	addi	s5,s5,520 # 65f8 <malloc+0x9a6>
      int fd = open("truncfile", O_WRONLY);
    13f8:	4585                	li	a1,1
    13fa:	8552                	mv	a0,s4
    ...
    1464:	16850513          	addi	a0,a0,360 # 65c8 <malloc+0x976>
    ...
    1480:	16450513          	addi	a0,a0,356 # 65e0 <malloc+0x98e>
    ...
    149e:	16e50513          	addi	a0,a0,366 # 6608 <malloc+0x9b6>
    ...
    14bc:	910a0a13          	addi	s4,s4,-1776 # 5dc8 <malloc+0x176>
    int n = write(fd, "xxx", 3);
    14c0:	00005a97          	auipc	s5,0x5
    14c4:	168a8a93          	addi	s5,s5,360 # 6628 <malloc+0x9d6>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    150e:	8be50513          	addi	a0,a0,-1858 # 5dc8 <malloc+0x176>
  ...
  exit(xstatus);
    ...
    152c:	0b850513          	addi	a0,a0,184 # 65e0 <malloc+0x98e>
    ...
    154a:	0ea50513          	addi	a0,a0,234 # 6630 <malloc+0x9de>
...
0000000000001560 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1572:	80278793          	addi	a5,a5,-2046 # 5d70 <malloc+0x11e>
    1576:	fcf43023          	sd	a5,-64(s0)
    157a:	00005797          	auipc	a5,0x5
    157e:	0d678793          	addi	a5,a5,214 # 6650 <malloc+0x9fe>
    1582:	fcf43423          	sd	a5,-56(s0)
    1586:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158a:	00005517          	auipc	a0,0x5
    158e:	0ce50513          	addi	a0,a0,206 # 6658 <malloc+0xa06>
  ...
  if(pid == 0) {
    ...
    15bc:	0a050513          	addi	a0,a0,160 # 6658 <malloc+0xa06>
    ...
    15d8:	0a450513          	addi	a0,a0,164 # 6678 <malloc+0xa26>
    ...
    15f4:	fd850513          	addi	a0,a0,-40 # 65c8 <malloc+0x976>
    ...
    1610:	05450513          	addi	a0,a0,84 # 6660 <malloc+0xa0e>
    ...
    162e:	74650513          	addi	a0,a0,1862 # 5d70 <malloc+0x11e>
  ...
  if(xstatus != 0)
    ...
    1662:	02a50513          	addi	a0,a0,42 # 6688 <malloc+0xa36>
    ...
    167e:	02650513          	addi	a0,a0,38 # 66a0 <malloc+0xa4e>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1692:	fca50513          	addi	a0,a0,-54 # 6658 <malloc+0xa06>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16bc:	a5850513          	addi	a0,a0,-1448 # 6110 <malloc+0x4be>
    ...
    16d8:	f0c50513          	addi	a0,a0,-244 # 65e0 <malloc+0x98e>
  ...
  unlink("echo-ok");
    ...
    16f2:	f6a50513          	addi	a0,a0,-150 # 6658 <malloc+0xa06>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171c:	fa050513          	addi	a0,a0,-96 # 66b8 <malloc+0xa66>
...
000000000000173c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1788:	62ca8a93          	addi	s5,s5,1580 # bdb0 <buf>
    178c:	864e                	mv	a2,s3
    178e:	85d6                	mv	a1,s5
    ...
    17a4:	61070713          	addi	a4,a4,1552 # bdb0 <buf>
    ...
    17dc:	ef850513          	addi	a0,a0,-264 # 66d0 <malloc+0xa7e>
    ...
    1802:	5b2b0b13          	addi	s6,s6,1458 # bdb0 <buf>
    ...
    1816:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x87>
{
    ...
    1862:	e8a50513          	addi	a0,a0,-374 # 66e8 <malloc+0xa96>
    ...
    187e:	e8650513          	addi	a0,a0,-378 # 6700 <malloc+0xaae>
    ...
    18b0:	e6c50513          	addi	a0,a0,-404 # 6718 <malloc+0xac6>
    ...
    18f0:	e4c50513          	addi	a0,a0,-436 # 6738 <malloc+0xae6>
...
0000000000001906 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1962:	c6a50513          	addi	a0,a0,-918 # 65c8 <malloc+0x976>
    ...
    197e:	dd650513          	addi	a0,a0,-554 # 6750 <malloc+0xafe>
    ...
    199a:	dd250513          	addi	a0,a0,-558 # 6768 <malloc+0xb16>
...
00000000000019ba <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a12:	bba50513          	addi	a0,a0,-1094 # 65c8 <malloc+0x976>
    ...
    1a36:	b9650513          	addi	a0,a0,-1130 # 65c8 <malloc+0x976>
...
0000000000001a54 <forkfork>:
{
    ...
    1ab0:	cdc50513          	addi	a0,a0,-804 # 6788 <malloc+0xb36>
    ...
    1ac2:	d74080e7          	jalr	-652(ra) # 5832 <exit>
{
    ...
    1b08:	c9450513          	addi	a0,a0,-876 # 6798 <malloc+0xb46>
...
0000000000001b1e <reparent2>:
{
  ...
  exit(0);
    ...
    1b56:	e9650513          	addi	a0,a0,-362 # 69e8 <malloc+0xd96>
...
0000000000001b86 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf4:	df850513          	addi	a0,a0,-520 # 69e8 <malloc+0xd96>
    ...
    1c20:	a4450513          	addi	a0,a0,-1468 # 6660 <malloc+0xa0e>
    ...
    1c92:	b2a50513          	addi	a0,a0,-1238 # 67b8 <malloc+0xb66>
    ...
    1cc6:	b0e50513          	addi	a0,a0,-1266 # 67d0 <malloc+0xb7e>
    ...
    1d2c:	ad050513          	addi	a0,a0,-1328 # 67f8 <malloc+0xba6>
  ...
  for(i = 0; i < N; i++){
    ...
    1d46:	2985                	addiw	s3,s3,1 # 3001 <iputtest+0x8d>
...
0000000000001dac <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dcc:	01850513          	addi	a0,a0,24 # 5de0 <malloc+0x18e>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1df6:	e6d9899b          	addiw	s3,s3,-403 # 41c64e6d <__BSS_END__+0x41c560ad>
    ...
    1e08:	fdca8a93          	addi	s5,s5,-36 # 5de0 <malloc+0x18e>
      link("cat", "x");
    1e0c:	00005b97          	auipc	s7,0x5
    1e10:	a14b8b93          	addi	s7,s7,-1516 # 6820 <malloc+0xbce>
    1e14:	a825                	j	1e4c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e16:	85a6                	mv	a1,s1
    1e18:	00004517          	auipc	a0,0x4
    1e1c:	7b050513          	addi	a0,a0,1968 # 65c8 <malloc+0x976>
...
0000000000001eae <manywrites>:
{
  ...
  exit(0);
    ...
    1f0a:	ae250513          	addi	a0,a0,-1310 # 69e8 <malloc+0xd96>
    ...
    1f46:	e6eb0b13          	addi	s6,s6,-402 # bdb0 <buf>
    ...
    1fba:	87250513          	addi	a0,a0,-1934 # 6828 <malloc+0xbd6>
    ...
    1fda:	e6a50513          	addi	a0,a0,-406 # 5e40 <malloc+0x1ee>
...
0000000000001ff8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2028:	83450513          	addi	a0,a0,-1996 # 6858 <malloc+0xc06>
  ...
  if(wait(0) != -1){
    ...
    208a:	7ba50513          	addi	a0,a0,1978 # 6840 <malloc+0xbee>
    ...
    20a6:	7de50513          	addi	a0,a0,2014 # 6880 <malloc+0xc2e>
    ...
    20c2:	7da50513          	addi	a0,a0,2010 # 6898 <malloc+0xc46>
...
00000000000020d8 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f4:	35098993          	addi	s3,s3,848 # c350 <buf+0x5a0>
    20f8:	1003d937          	lui	s2,0x1003d
    20fc:	090e                	slli	s2,s2,0x3
    20fe:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e6c0>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2142:	48a50513          	addi	a0,a0,1162 # 65c8 <malloc+0x976>
    ...
    2164:	75050513          	addi	a0,a0,1872 # 68b0 <malloc+0xc5e>
...
0000000000002184 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21e6:	3e650513          	addi	a0,a0,998 # 65c8 <malloc+0x976>
    ...
    2212:	6c250513          	addi	a0,a0,1730 # 68d0 <malloc+0xc7e>
...
0000000000002232 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2242:	6aa50513          	addi	a0,a0,1706 # 68e8 <malloc+0xc96>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2274:	67850513          	addi	a0,a0,1656 # 68e8 <malloc+0xc96>
  ...
  close(fd);
    ...
    229a:	30278793          	addi	a5,a5,770 # 8598 <args.1>
    229e:	00006697          	auipc	a3,0x6
    22a2:	3f268693          	addi	a3,a3,1010 # 8690 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22a6:	00004717          	auipc	a4,0x4
    22aa:	65270713          	addi	a4,a4,1618 # 68f8 <malloc+0xca6>
    ...
    22fe:	6de50513          	addi	a0,a0,1758 # 69d8 <malloc+0xd86>
    ...
    2322:	6da50513          	addi	a0,a0,1754 # 69f8 <malloc+0xda6>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2380:	69c50513          	addi	a0,a0,1692 # 6a18 <malloc+0xdc6>
    ...
    239c:	23050513          	addi	a0,a0,560 # 65c8 <malloc+0x976>
...
00000000000023bc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2436:	28e78793          	addi	a5,a5,654 # 76c0 <malloc+0x1a6e>
  ...
  if(ret != -1){
    ...
    2478:	5cc50513          	addi	a0,a0,1484 # 6a40 <malloc+0xdee>
    ...
    2496:	05650513          	addi	a0,a0,86 # 64e8 <malloc+0x896>
    ...
    24b4:	05850513          	addi	a0,a0,88 # 6508 <malloc+0x8b6>
    ...
    24d4:	05850513          	addi	a0,a0,88 # 6528 <malloc+0x8d6>
    ...
    24f2:	06250513          	addi	a0,a0,98 # 6550 <malloc+0x8fe>
...
0000000000002508 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    253e:	54650513          	addi	a0,a0,1350 # 6a80 <malloc+0xe2e>
  ...
  if(n >= 0){
    ...
    256e:	53650513          	addi	a0,a0,1334 # 6aa0 <malloc+0xe4e>
    ...
    2588:	4c450513          	addi	a0,a0,1220 # 6a48 <malloc+0xdf6>
    ...
    25a2:	4c250513          	addi	a0,a0,1218 # 6a60 <malloc+0xe0e>
    ...
    25bc:	4d050513          	addi	a0,a0,1232 # 6a88 <malloc+0xe36>
  ...
  unlink("rwsbrk");
    ...
    25e0:	4a450513          	addi	a0,a0,1188 # 6a80 <malloc+0xe2e>
    25e4:	00003097          	auipc	ra,0x3
    25e8:	29e080e7          	jalr	670(ra) # 5882 <unlink>
  fd = open("README", O_RDONLY);
    25ec:	4581                	li	a1,0
    25ee:	00004517          	auipc	a0,0x4
    25f2:	92a50513          	addi	a0,a0,-1750 # 5f18 <malloc+0x2c6>
  ...
  if(n >= 0){
    ...
    261c:	4b850513          	addi	a0,a0,1208 # 6ad0 <malloc+0xe7e>
    ...
    2636:	45650513          	addi	a0,a0,1110 # 6a88 <malloc+0xe36>
...
0000000000002660 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26b6:	44650513          	addi	a0,a0,1094 # 6af8 <malloc+0xea6>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2708:	41450513          	addi	a0,a0,1044 # 6b18 <malloc+0xec6>
  ...
  if(c != a + 1){
    ...
    276c:	41050513          	addi	a0,a0,1040 # 6b78 <malloc+0xf26>
    ...
    278e:	3ae50513          	addi	a0,a0,942 # 6b38 <malloc+0xee6>
    ...
    27aa:	3b250513          	addi	a0,a0,946 # 6b58 <malloc+0xf06>
...
00000000000027e6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    28f4:	2a850513          	addi	a0,a0,680 # 6b98 <malloc+0xf46>
    ...
    2910:	2d450513          	addi	a0,a0,724 # 6be0 <malloc+0xf8e>
    ...
    2930:	2d450513          	addi	a0,a0,724 # 6c00 <malloc+0xfae>
    ...
    2950:	2f450513          	addi	a0,a0,756 # 6c40 <malloc+0xfee>
    ...
    296c:	30850513          	addi	a0,a0,776 # 6c70 <malloc+0x101e>
    ...
    298c:	32050513          	addi	a0,a0,800 # 6ca8 <malloc+0x1056>
...
00000000000029a2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29c6:	30e50513          	addi	a0,a0,782 # 6cd0 <malloc+0x107e>
    29ca:	00003097          	auipc	ra,0x3
    29ce:	ea8080e7          	jalr	-344(ra) # 5872 <open>
    29d2:	84aa                	mv	s1,a0
  unlink("sbrk");
    29d4:	00004517          	auipc	a0,0x4
    29d8:	2fc50513          	addi	a0,a0,764 # 6cd0 <malloc+0x107e>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a2c:	2b050513          	addi	a0,a0,688 # 6cd8 <malloc+0x1086>
    ...
    2a48:	2ac50513          	addi	a0,a0,684 # 6cf0 <malloc+0x109e>
    ...
    2a64:	c7050513          	addi	a0,a0,-912 # 66d0 <malloc+0xa7e>
...
0000000000002a7a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a8e:	27e50513          	addi	a0,a0,638 # 6d08 <malloc+0x10b6>
  ...
  close(fd);
    ...
    2ad6:	b0e50513          	addi	a0,a0,-1266 # 65e0 <malloc+0x98e>
...
0000000000002aec <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b24:	ec850513          	addi	a0,a0,-312 # 69e8 <malloc+0xd96>
  ...
  if(pid == 0){
    ...
    2b7a:	e7250513          	addi	a0,a0,-398 # 69e8 <malloc+0xd96>
  ...
  if(pid == 0){
    ...
    2bb2:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x1160>
    ...
    2bda:	e1250513          	addi	a0,a0,-494 # 69e8 <malloc+0xd96>
...
0000000000002cd6 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2ce2:	0511                	addi	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff1244>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d4e:	c9e50513          	addi	a0,a0,-866 # 69e8 <malloc+0xd96>
    ...
    2da2:	fd250513          	addi	a0,a0,-46 # 5d70 <malloc+0x11e>
    2da6:	faa43c23          	sd	a0,-72(s0)
    2daa:	00003797          	auipc	a5,0x3
    2dae:	03678793          	addi	a5,a5,54 # 5de0 <malloc+0x18e>
...
0000000000002dd0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de0:	10450513          	addi	a0,a0,260 # 6ee0 <malloc+0x128e>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2df2:	f4a50513          	addi	a0,a0,-182 # 6d38 <malloc+0x10e6>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e08:	f8c50513          	addi	a0,a0,-116 # 6d90 <malloc+0x113e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e26:	fe650513          	addi	a0,a0,-26 # 6e08 <malloc+0x11b6>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e42:	03a50513          	addi	a0,a0,58 # 6e78 <malloc+0x1226>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e54:	08050513          	addi	a0,a0,128 # 6ed0 <malloc+0x127e>
  ...
  unlink("12345678901234");
    ...
    2ed2:	e4250513          	addi	a0,a0,-446 # 6d10 <malloc+0x10be>
    ...
    2eee:	e6e50513          	addi	a0,a0,-402 # 6d58 <malloc+0x1106>
    ...
    2f0a:	eba50513          	addi	a0,a0,-326 # 6dc0 <malloc+0x116e>
    ...
    2f26:	f1650513          	addi	a0,a0,-234 # 6e38 <malloc+0x11e6>
    ...
    2f42:	f5a50513          	addi	a0,a0,-166 # 6e98 <malloc+0x1246>
    ...
    2f5e:	f9650513          	addi	a0,a0,-106 # 6ef0 <malloc+0x129e>
...
0000000000002f74 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f84:	fa850513          	addi	a0,a0,-88 # 6f28 <malloc+0x12d6>
  ...
  if(chdir("iputdir") < 0){
    ...
    2f98:	f9450513          	addi	a0,a0,-108 # 6f28 <malloc+0x12d6>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fac:	fc050513          	addi	a0,a0,-64 # 6f68 <malloc+0x1316>
  ...
  if(chdir("/") < 0){
    ...
    2fc0:	fdc50513          	addi	a0,a0,-36 # 6f98 <malloc+0x1346>
    ...
    2fe0:	f5450513          	addi	a0,a0,-172 # 6f30 <malloc+0x12de>
    ...
    2ffc:	f5050513          	addi	a0,a0,-176 # 6f48 <malloc+0x12f6>
    ...
    3018:	f6450513          	addi	a0,a0,-156 # 6f78 <malloc+0x1326>
    ...
    3034:	f7050513          	addi	a0,a0,-144 # 6fa0 <malloc+0x134e>
...
000000000000304a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3068:	ec450513          	addi	a0,a0,-316 # 6f28 <malloc+0x12d6>
    ...
    307c:	eb050513          	addi	a0,a0,-336 # 6f28 <malloc+0x12d6>
    ...
    3090:	edc50513          	addi	a0,a0,-292 # 6f68 <malloc+0x1316>
    ...
    30b0:	51c50513          	addi	a0,a0,1308 # 65c8 <malloc+0x976>
    ...
    30cc:	e6850513          	addi	a0,a0,-408 # 6f30 <malloc+0x12de>
    ...
    30e8:	ed450513          	addi	a0,a0,-300 # 6fb8 <malloc+0x1366>
    ...
    3104:	e7850513          	addi	a0,a0,-392 # 6f78 <malloc+0x1326>
...
0000000000003132 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3142:	e9250513          	addi	a0,a0,-366 # 6fd0 <malloc+0x137e>
  ...
  if(chdir("dir0") < 0){
    ...
    3156:	e7e50513          	addi	a0,a0,-386 # 6fd0 <malloc+0x137e>
  ...
  if(chdir("..") < 0){
    ...
    316a:	e8a50513          	addi	a0,a0,-374 # 6ff0 <malloc+0x139e>
  ...
  if(unlink("dir0") < 0){
    ...
    317e:	e5650513          	addi	a0,a0,-426 # 6fd0 <malloc+0x137e>
    ...
    319e:	d9650513          	addi	a0,a0,-618 # 6f30 <malloc+0x12de>
    ...
    31ba:	e2250513          	addi	a0,a0,-478 # 6fd8 <malloc+0x1386>
    ...
    31d6:	e2650513          	addi	a0,a0,-474 # 6ff8 <malloc+0x13a6>
    ...
    31f2:	e2250513          	addi	a0,a0,-478 # 7010 <malloc+0x13be>
...
0000000000003208 <subdir>:
{
  ...
  unlink("ff");
    ...
    321a:	f4250513          	addi	a0,a0,-190 # 7158 <malloc+0x1506>
    321e:	00002097          	auipc	ra,0x2
    3222:	664080e7          	jalr	1636(ra) # 5882 <unlink>
  if(mkdir("dd") != 0){
    3226:	00004517          	auipc	a0,0x4
    322a:	e0250513          	addi	a0,a0,-510 # 7028 <malloc+0x13d6>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3242:	e0a50513          	addi	a0,a0,-502 # 7048 <malloc+0x13f6>
  ...
  write(fd, "ff", 2);
    ...
    325a:	f0258593          	addi	a1,a1,-254 # 7158 <malloc+0x1506>
  ...
  if(unlink("dd") >= 0){
    ...
    3274:	db850513          	addi	a0,a0,-584 # 7028 <malloc+0x13d6>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3288:	e1c50513          	addi	a0,a0,-484 # 70a0 <malloc+0x144e>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e2c50513          	addi	a0,a0,-468 # 70c8 <malloc+0x1476>
  ...
  write(fd, "FF", 2);
    ...
    32b8:	e4458593          	addi	a1,a1,-444 # 70f8 <malloc+0x14a6>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32d4:	e3050513          	addi	a0,a0,-464 # 7100 <malloc+0x14ae>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32ec:	ac858593          	addi	a1,a1,-1336 # bdb0 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    331c:	e3858593          	addi	a1,a1,-456 # 7150 <malloc+0x14fe>
    3320:	00004517          	auipc	a0,0x4
    3324:	da850513          	addi	a0,a0,-600 # 70c8 <malloc+0x1476>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3338:	d9450513          	addi	a0,a0,-620 # 70c8 <malloc+0x1476>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    334e:	d7e50513          	addi	a0,a0,-642 # 70c8 <malloc+0x1476>
  ...
  if(chdir("dd") != 0){
    ...
    3362:	cca50513          	addi	a0,a0,-822 # 7028 <malloc+0x13d6>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3376:	e7650513          	addi	a0,a0,-394 # 71e8 <malloc+0x1596>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    338a:	e9250513          	addi	a0,a0,-366 # 7218 <malloc+0x15c6>
  ...
  if(chdir("./..") != 0){
    ...
    339e:	eae50513          	addi	a0,a0,-338 # 7248 <malloc+0x15f6>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33b4:	da050513          	addi	a0,a0,-608 # 7150 <malloc+0x14fe>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33cc:	9e858593          	addi	a1,a1,-1560 # bdb0 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ee:	cde50513          	addi	a0,a0,-802 # 70c8 <malloc+0x1476>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3406:	ed650513          	addi	a0,a0,-298 # 72d8 <malloc+0x1686>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    341e:	eee50513          	addi	a0,a0,-274 # 7308 <malloc+0x16b6>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3436:	bf650513          	addi	a0,a0,-1034 # 7028 <malloc+0x13d6>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    344c:	be050513          	addi	a0,a0,-1056 # 7028 <malloc+0x13d6>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3462:	bca50513          	addi	a0,a0,-1078 # 7028 <malloc+0x13d6>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3476:	f2658593          	addi	a1,a1,-218 # 7398 <malloc+0x1746>
    347a:	00004517          	auipc	a0,0x4
    347e:	e5e50513          	addi	a0,a0,-418 # 72d8 <malloc+0x1686>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3492:	f0a58593          	addi	a1,a1,-246 # 7398 <malloc+0x1746>
    3496:	00004517          	auipc	a0,0x4
    349a:	e7250513          	addi	a0,a0,-398 # 7308 <malloc+0x16b6>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34ae:	ca658593          	addi	a1,a1,-858 # 7150 <malloc+0x14fe>
    34b2:	00004517          	auipc	a0,0x4
    34b6:	b9650513          	addi	a0,a0,-1130 # 7048 <malloc+0x13f6>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34ca:	e1250513          	addi	a0,a0,-494 # 72d8 <malloc+0x1686>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34de:	e2e50513          	addi	a0,a0,-466 # 7308 <malloc+0x16b6>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34f2:	c6250513          	addi	a0,a0,-926 # 7150 <malloc+0x14fe>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3506:	e0650513          	addi	a0,a0,-506 # 7308 <malloc+0x16b6>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    351a:	dc250513          	addi	a0,a0,-574 # 72d8 <malloc+0x1686>
  ...
  if(chdir("dd/ff") == 0){
    ...
    352e:	b1e50513          	addi	a0,a0,-1250 # 7048 <malloc+0x13f6>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3542:	faa50513          	addi	a0,a0,-86 # 74e8 <malloc+0x1896>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3556:	bfe50513          	addi	a0,a0,-1026 # 7150 <malloc+0x14fe>
  ...
  if(unlink("dd/ff") != 0){
    ...
    356a:	ae250513          	addi	a0,a0,-1310 # 7048 <malloc+0x13f6>
  ...
  if(unlink("dd") == 0){
    ...
    357e:	aae50513          	addi	a0,a0,-1362 # 7028 <malloc+0x13d6>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3592:	fca50513          	addi	a0,a0,-54 # 7558 <malloc+0x1906>
  ...
  if(unlink("dd") < 0){
    ...
    35a6:	a8650513          	addi	a0,a0,-1402 # 7028 <malloc+0x13d6>
    ...
    35c8:	a6c50513          	addi	a0,a0,-1428 # 7030 <malloc+0x13de>
    ...
    35e4:	a7050513          	addi	a0,a0,-1424 # 7050 <malloc+0x13fe>
    ...
    3600:	a7450513          	addi	a0,a0,-1420 # 7070 <malloc+0x141e>
    ...
    361c:	a9050513          	addi	a0,a0,-1392 # 70a8 <malloc+0x1456>
    ...
    3638:	aa450513          	addi	a0,a0,-1372 # 70d8 <malloc+0x1486>
    ...
    3654:	ac050513          	addi	a0,a0,-1344 # 7110 <malloc+0x14be>
    ...
    3670:	ac450513          	addi	a0,a0,-1340 # 7130 <malloc+0x14de>
    ...
    368c:	ad850513          	addi	a0,a0,-1320 # 7160 <malloc+0x150e>
    ...
    36a8:	ae450513          	addi	a0,a0,-1308 # 7188 <malloc+0x1536>
    ...
    36c4:	ae850513          	addi	a0,a0,-1304 # 71a8 <malloc+0x1556>
    ...
    36e0:	af450513          	addi	a0,a0,-1292 # 71d0 <malloc+0x157e>
    ...
    36fc:	b0050513          	addi	a0,a0,-1280 # 71f8 <malloc+0x15a6>
    ...
    3718:	b1450513          	addi	a0,a0,-1260 # 7228 <malloc+0x15d6>
    ...
    3734:	b2050513          	addi	a0,a0,-1248 # 7250 <malloc+0x15fe>
    ...
    3750:	b1c50513          	addi	a0,a0,-1252 # 7268 <malloc+0x1616>
    ...
    376c:	b2050513          	addi	a0,a0,-1248 # 7288 <malloc+0x1636>
    ...
    3788:	b2450513          	addi	a0,a0,-1244 # 72a8 <malloc+0x1656>
    ...
    37a4:	b4850513          	addi	a0,a0,-1208 # 72e8 <malloc+0x1696>
    ...
    37c0:	b5c50513          	addi	a0,a0,-1188 # 7318 <malloc+0x16c6>
    ...
    37dc:	b6050513          	addi	a0,a0,-1184 # 7338 <malloc+0x16e6>
    ...
    37f8:	b6450513          	addi	a0,a0,-1180 # 7358 <malloc+0x1706>
    ...
    3814:	b6850513          	addi	a0,a0,-1176 # 7378 <malloc+0x1726>
    ...
    3830:	b7c50513          	addi	a0,a0,-1156 # 73a8 <malloc+0x1756>
    ...
    384c:	b8850513          	addi	a0,a0,-1144 # 73d0 <malloc+0x177e>
    ...
    3868:	b9450513          	addi	a0,a0,-1132 # 73f8 <malloc+0x17a6>
    ...
    3884:	ba050513          	addi	a0,a0,-1120 # 7420 <malloc+0x17ce>
    ...
    38a0:	ba450513          	addi	a0,a0,-1116 # 7440 <malloc+0x17ee>
    ...
    38bc:	ba850513          	addi	a0,a0,-1112 # 7460 <malloc+0x180e>
    ...
    38d8:	bb450513          	addi	a0,a0,-1100 # 7488 <malloc+0x1836>
    ...
    38f4:	bb850513          	addi	a0,a0,-1096 # 74a8 <malloc+0x1856>
    ...
    3910:	bbc50513          	addi	a0,a0,-1092 # 74c8 <malloc+0x1876>
    ...
    392c:	bc850513          	addi	a0,a0,-1080 # 74f0 <malloc+0x189e>
    ...
    3948:	84450513          	addi	a0,a0,-1980 # 7188 <malloc+0x1536>
    ...
    3964:	bb050513          	addi	a0,a0,-1104 # 7510 <malloc+0x18be>
    ...
    3980:	bb450513          	addi	a0,a0,-1100 # 7530 <malloc+0x18de>
    ...
    399c:	bc850513          	addi	a0,a0,-1080 # 7560 <malloc+0x190e>
    ...
    39b8:	bcc50513          	addi	a0,a0,-1076 # 7580 <malloc+0x192e>
...
00000000000039ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39de:	bbe50513          	addi	a0,a0,-1090 # 7598 <malloc+0x1946>
  ...
  if(chdir("dots") != 0){
    ...
    39f0:	bac50513          	addi	a0,a0,-1108 # 7598 <malloc+0x1946>
  ...
  if(unlink(".") == 0){
    ...
    3a02:	a2a50513          	addi	a0,a0,-1494 # 6428 <malloc+0x7d6>
  ...
  if(unlink("..") == 0){
    ...
    3a14:	5e050513          	addi	a0,a0,1504 # 6ff0 <malloc+0x139e>
  ...
  if(chdir("/") != 0){
    ...
    3a26:	57650513          	addi	a0,a0,1398 # 6f98 <malloc+0x1346>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a38:	bcc50513          	addi	a0,a0,-1076 # 7600 <malloc+0x19ae>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a4a:	be250513          	addi	a0,a0,-1054 # 7628 <malloc+0x19d6>
  ...
  if(unlink("dots") != 0){
    ...
    3a5c:	b4050513          	addi	a0,a0,-1216 # 7598 <malloc+0x1946>
    ...
    3a7a:	b2a50513          	addi	a0,a0,-1238 # 75a0 <malloc+0x194e>
    ...
    3a96:	b2650513          	addi	a0,a0,-1242 # 75b8 <malloc+0x1966>
    ...
    3ab2:	b2250513          	addi	a0,a0,-1246 # 75d0 <malloc+0x197e>
    ...
    3ace:	b1e50513          	addi	a0,a0,-1250 # 75e8 <malloc+0x1996>
    ...
    3aea:	4ba50513          	addi	a0,a0,1210 # 6fa0 <malloc+0x134e>
    ...
    3b06:	b0650513          	addi	a0,a0,-1274 # 7608 <malloc+0x19b6>
    ...
    3b22:	b1250513          	addi	a0,a0,-1262 # 7630 <malloc+0x19de>
    ...
    3b3e:	b1650513          	addi	a0,a0,-1258 # 7650 <malloc+0x19fe>
...
0000000000003b54 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b6a:	b0a50513          	addi	a0,a0,-1270 # 7670 <malloc+0x1a1e>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b86:	aee50513          	addi	a0,a0,-1298 # 7670 <malloc+0x1a1e>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3b9a:	b2250513          	addi	a0,a0,-1246 # 76b8 <malloc+0x1a66>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bb2:	b0a50513          	addi	a0,a0,-1270 # 76b8 <malloc+0x1a66>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bc6:	af650513          	addi	a0,a0,-1290 # 76b8 <malloc+0x1a66>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3bda:	ae250513          	addi	a0,a0,-1310 # 76b8 <malloc+0x1a66>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bee:	ace58593          	addi	a1,a1,-1330 # 76b8 <malloc+0x1a66>
    3bf2:	00002517          	auipc	a0,0x2
    3bf6:	32650513          	addi	a0,a0,806 # 5f18 <malloc+0x2c6>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c0a:	a6a50513          	addi	a0,a0,-1430 # 7670 <malloc+0x1a1e>
  ...
  fd = open(".", O_RDWR);
    ...
    3c20:	80c50513          	addi	a0,a0,-2036 # 6428 <malloc+0x7d6>
  ...
  fd = open(".", 0);
    ...
    3c36:	7f650513          	addi	a0,a0,2038 # 6428 <malloc+0x7d6>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c4a:	19a58593          	addi	a1,a1,410 # 5de0 <malloc+0x18e>
  ...
  close(fd);
    ...
    3c76:	a0650513          	addi	a0,a0,-1530 # 7678 <malloc+0x1a26>
    ...
    3c92:	a0a50513          	addi	a0,a0,-1526 # 7698 <malloc+0x1a46>
    ...
    3cae:	a1e50513          	addi	a0,a0,-1506 # 76c8 <malloc+0x1a76>
    ...
    3cca:	a0250513          	addi	a0,a0,-1534 # 76c8 <malloc+0x1a76>
    ...
    3ce6:	a0e50513          	addi	a0,a0,-1522 # 76f0 <malloc+0x1a9e>
    ...
    3d02:	a1a50513          	addi	a0,a0,-1510 # 7718 <malloc+0x1ac6>
    ...
    3d1e:	a2650513          	addi	a0,a0,-1498 # 7740 <malloc+0x1aee>
    ...
    3d3a:	a3250513          	addi	a0,a0,-1486 # 7768 <malloc+0x1b16>
    ...
    3d56:	a3650513          	addi	a0,a0,-1482 # 7788 <malloc+0x1b36>
    ...
    3d72:	a4250513          	addi	a0,a0,-1470 # 77b0 <malloc+0x1b5e>
...
0000000000003d88 <iref>:
{
    ...
    3da6:	a26a0a13          	addi	s4,s4,-1498 # 77c8 <malloc+0x1b76>
    mkdir("");
    3daa:	00003497          	auipc	s1,0x3
    3dae:	52648493          	addi	s1,s1,1318 # 72d0 <malloc+0x167e>
    link("README", "");
    3db2:	00002a97          	auipc	s5,0x2
    3db6:	166a8a93          	addi	s5,s5,358 # 5f18 <malloc+0x2c6>
    fd = open("xx", O_CREATE);
    3dba:	00004997          	auipc	s3,0x4
    3dbe:	90698993          	addi	s3,s3,-1786 # 76c0 <malloc+0x1a6e>
    3dc2:	a891                	j	3e16 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dc4:	85da                	mv	a1,s6
    3dc6:	00004517          	auipc	a0,0x4
    3dca:	a0a50513          	addi	a0,a0,-1526 # 77d0 <malloc+0x1b7e>
    ...
    3de6:	a0650513          	addi	a0,a0,-1530 # 77e8 <malloc+0x1b96>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e7a:	17a98993          	addi	s3,s3,378 # 6ff0 <malloc+0x139e>
    unlink("irefd");
    3e7e:	00004917          	auipc	s2,0x4
    3e82:	94a90913          	addi	s2,s2,-1718 # 77c8 <malloc+0x1b76>
    chdir("..");
    3e86:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3ea2:	0fa50513          	addi	a0,a0,250 # 6f98 <malloc+0x1346>
...
0000000000003ec2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ed2:	93250513          	addi	a0,a0,-1742 # 7800 <malloc+0x1bae>
  ...
  if(pid == 0){
    ...
    3ef6:	90e50513          	addi	a0,a0,-1778 # 7800 <malloc+0x1bae>
    ...
    3f0c:	91850513          	addi	a0,a0,-1768 # 7820 <malloc+0x1bce>
    ...
    3f28:	8e450513          	addi	a0,a0,-1820 # 7808 <malloc+0x1bb6>
    ...
    3f44:	68850513          	addi	a0,a0,1672 # 65c8 <malloc+0x976>
  ...
  if(unlink("oidir") != 0){
    ...
    3f72:	89250513          	addi	a0,a0,-1902 # 7800 <malloc+0x1bae>
    ...
    3f86:	83650513          	addi	a0,a0,-1994 # 67b8 <malloc+0xb66>
...
0000000000003fb4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fc4:	88850513          	addi	a0,a0,-1912 # 7848 <malloc+0x1bf6>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff0:	85c50513          	addi	a0,a0,-1956 # 7848 <malloc+0x1bf6>
  ...
  sleep(10); // one second
    ...
    4028:	76450513          	addi	a0,a0,1892 # 6788 <malloc+0xb36>
    ...
    4042:	80a48493          	addi	s1,s1,-2038 # 7848 <malloc+0x1bf6>
    4046:	4581                	li	a1,0
    4048:	8526                	mv	a0,s1
    ...
    406a:	7e250513          	addi	a0,a0,2018 # 7848 <malloc+0x1bf6>
...
000000000000408a <killstatus>:
{
  ...
  exit(0);
    ...
    40f0:	4dc50513          	addi	a0,a0,1244 # 65c8 <malloc+0x976>
    ...
    4116:	74650513          	addi	a0,a0,1862 # 7858 <malloc+0x1c06>
...
000000000000412c <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4156:	63650513          	addi	a0,a0,1590 # 6788 <malloc+0xb36>
  ...
  if(pid2 == 0)
    ...
    4184:	44850513          	addi	a0,a0,1096 # 65c8 <malloc+0x976>
  ...
  if(pid3 == 0){
    ...
    41c8:	c1c58593          	addi	a1,a1,-996 # 5de0 <malloc+0x18e>
    ...
    41f2:	3da50513          	addi	a0,a0,986 # 65c8 <malloc+0x976>
    ...
    420e:	66e50513          	addi	a0,a0,1646 # 7878 <malloc+0x1c26>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    422e:	b8658593          	addi	a1,a1,-1146 # bdb0 <buf>
    ...
    424a:	64a50513          	addi	a0,a0,1610 # 7890 <malloc+0x1c3e>
  ...
  printf("kill... ");
    ...
    4276:	63650513          	addi	a0,a0,1590 # 78a8 <malloc+0x1c56>
  ...
  printf("wait... ");
    ...
    42a4:	61850513          	addi	a0,a0,1560 # 78b8 <malloc+0x1c66>
...
00000000000042d0 <reparent>:
{
  ...
  exit(0);
    ...
    4324:	2a850513          	addi	a0,a0,680 # 65c8 <malloc+0x976>
    ...
    4340:	41450513          	addi	a0,a0,1044 # 6750 <malloc+0xafe>
...
0000000000004380 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b6:	31e50513          	addi	a0,a0,798 # 66d0 <malloc+0xa7e>
    ...
    43ea:	9fa58593          	addi	a1,a1,-1542 # 5de0 <malloc+0x18e>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44ae:	41e50513          	addi	a0,a0,1054 # 78c8 <malloc+0x1c76>
    ...
    44ca:	10250513          	addi	a0,a0,258 # 65c8 <malloc+0x976>
    ...
    4516:	3d650513          	addi	a0,a0,982 # 78e8 <malloc+0x1c96>
...
0000000000004536 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4552:	71190913          	addi	s2,s2,1809 # 2711 <sbrkbasic+0xb1>
  if((pid = fork()) == 0){
    ...
    45ba:	36250513          	addi	a0,a0,866 # 7918 <malloc+0x1cc6>
...
00000000000045da <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4670:	2dc50513          	addi	a0,a0,732 # 7948 <malloc+0x1cf6>
    ...
    468c:	2e850513          	addi	a0,a0,744 # 7970 <malloc+0x1d1e>
  ...
  fd = open("sharedfd", 0);
    ...
    46d0:	26c50513          	addi	a0,a0,620 # 7938 <malloc+0x1ce6>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4710:	28450513          	addi	a0,a0,644 # 7990 <malloc+0x1d3e>
...
0000000000004792 <fourfiles>:
{
    ...
    47ae:	1100                	addi	s0,sp,160
    47b0:	8caa                	mv	s9,a0
  char *names[] = { "f0", "f1", "f2", "f3" };
    47b2:	00003797          	auipc	a5,0x3
    47b6:	21e78793          	addi	a5,a5,542 # 79d0 <malloc+0x1d7e>
    47ba:	f6f43823          	sd	a5,-144(s0)
    47be:	00003797          	auipc	a5,0x3
    47c2:	21a78793          	addi	a5,a5,538 # 79d8 <malloc+0x1d86>
    47c6:	f6f43c23          	sd	a5,-136(s0)
    47ca:	00003797          	auipc	a5,0x3
    47ce:	21678793          	addi	a5,a5,534 # 79e0 <malloc+0x1d8e>
    47d2:	f8f43023          	sd	a5,-128(s0)
    47d6:	00003797          	auipc	a5,0x3
    47da:	21278793          	addi	a5,a5,530 # 79e8 <malloc+0x1d96>
    47de:	f8f43423          	sd	a5,-120(s0)
  for(pi = 0; pi < NCHILD; pi++){
    47e2:	f7040b93          	addi	s7,s0,-144
  char *names[] = { "f0", "f1", "f2", "f3" };
    47e6:	895e                	mv	s2,s7
  for(pi = 0; pi < NCHILD; pi++){
    47e8:	4481                	li	s1,0
  ...
  for(pi = 0; pi < NCHILD; pi++){
    4808:	2485                	addiw	s1,s1,1
    480a:	0921                	addi	s2,s2,8
    480c:	ff4490e3          	bne	s1,s4,47ec <fourfiles+0x5a>
    4810:	4491                	li	s1,4
    wait(&xstatus);
    4812:	f6c40513          	addi	a0,s0,-148
  ...
  for(pi = 0; pi < NCHILD; pi++){
    4826:	34fd                	addiw	s1,s1,-1
    4828:	f4ed                	bnez	s1,4812 <fourfiles+0x80>
    482a:	03000b13          	li	s6,48
    while((n = read(fd, buf, sizeof(buf))) > 0){
    482e:	00007a17          	auipc	s4,0x7
    4832:	582a0a13          	addi	s4,s4,1410 # bdb0 <buf>
    if(total != N*SZ){
    4836:	6d05                	lui	s10,0x1
    4838:	770d0d13          	addi	s10,s10,1904 # 1770 <pipe1+0x34>
  for(i = 0; i < NCHILD; i++){
    ...
    4848:	1a450513          	addi	a0,a0,420 # 69e8 <malloc+0xd96>
    ...
    48c2:	13250513          	addi	a0,a0,306 # 79f0 <malloc+0x1d9e>
    ...
    48dc:	12850513          	addi	a0,a0,296 # 7a00 <malloc+0x1dae>
    ...
    4902:	11a50513          	addi	a0,a0,282 # 7a18 <malloc+0x1dc6>
    ...
    4932:	48278793          	addi	a5,a5,1154 # bdb0 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    4962:	0ba1                	addi	s7,s7,8
    4964:	2b05                	addiw	s6,s6,1
    ...
    498a:	0a250513          	addi	a0,a0,162 # 7a28 <malloc+0x1dd6>
    ...
    49ba:	610d                	addi	sp,sp,160
    49bc:	8082                	ret

00000000000049be <concreate>:
{
    49be:	7135                	addi	sp,sp,-160
  ...
  for(i = 0; i < N; i++){
    ...
    49ec:	058b8b93          	addi	s7,s7,88 # 7a40 <malloc+0x1dee>
  for(i = 0; i < N; i++){
    49f0:	02800a13          	li	s4,40
    49f4:	acc9                	j	4cc6 <concreate+0x308>
      link("C0", file);
    49f6:	fa840593          	addi	a1,s0,-88
    49fa:	855e                	mv	a0,s7
    ...
    4a26:	fa840593          	addi	a1,s0,-88
    4a2a:	00003517          	auipc	a0,0x3
    4a2e:	01e50513          	addi	a0,a0,30 # 7a48 <malloc+0x1df6>
    ...
    4a40:	df6080e7          	jalr	-522(ra) # 5832 <exit>
      link("C0", file);
    4a44:	fa840593          	addi	a1,s0,-88
    4a48:	00003517          	auipc	a0,0x3
    4a4c:	ff850513          	addi	a0,a0,-8 # 7a40 <malloc+0x1dee>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b12:	f7240613          	addi	a2,s0,-142
    4b16:	85ce                	mv	a1,s3
    4b18:	00003517          	auipc	a0,0x3
    4b1c:	f7050513          	addi	a0,a0,-144 # 7a88 <malloc+0x1e36>
  ...
  for(i = 0; i < N; i++){
    ...
    4b54:	f6050513          	addi	a0,a0,-160 # 7ab0 <malloc+0x1e5e>
    ...
    4b70:	a5c50513          	addi	a0,a0,-1444 # 65c8 <malloc+0x976>
  ...
  for(i = 0; i < N; i++){
    4cc0:	2905                	addiw	s2,s2,1
    4cc2:	db4905e3          	beq	s2,s4,4a6c <concreate+0xae>
    file[1] = '0' + i;
    4cc6:	0309079b          	addiw	a5,s2,48
    4cca:	faf404a3          	sb	a5,-87(s0)
    unlink(file);
    4cce:	fa840513          	addi	a0,s0,-88
...
0000000000004d1a <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d5a:	05a90913          	addi	s2,s2,90 # bdb0 <buf>
  for(i = 0; i < N; i++){
    4d5e:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4da2:	d4a50513          	addi	a0,a0,-694 # 7ae8 <malloc+0x1e96>
  ...
  for(i = 0; ; i++){
    ...
    4db8:	ffc90913          	addi	s2,s2,-4 # bdb0 <buf>
  if(fd < 0){
    ...
    4dde:	01f4d79b          	srliw	a5,s1,0x1f
    4de2:	9fa5                	addw	a5,a5,s1
    4de4:	4017d79b          	sraiw	a5,a5,0x1
  ...
  for(i = 0; ; i++){
    ...
    4e06:	cf650513          	addi	a0,a0,-778 # 7af8 <malloc+0x1ea6>
    ...
    4e22:	cfa50513          	addi	a0,a0,-774 # 7b18 <malloc+0x1ec6>
    ...
    4e3e:	cfe50513          	addi	a0,a0,-770 # 7b38 <malloc+0x1ee6>
    ...
    4e5a:	d0250513          	addi	a0,a0,-766 # 7b58 <malloc+0x1f06>
    ...
    4e76:	d0650513          	addi	a0,a0,-762 # 7b78 <malloc+0x1f26>
    ...
    4e92:	d0250513          	addi	a0,a0,-766 # 7b90 <malloc+0x1f3e>
  ...
  if(total != N*SZ){
    ...
    4eb4:	ee078793          	addi	a5,a5,-288 # 2ee0 <fourteen+0x110>
    4eb8:	02f99363          	bne	s3,a5,4ede <bigfile+0x1c4>
  unlink("bigfile.dat");
    4ebc:	00003517          	auipc	a0,0x3
    4ec0:	c2c50513          	addi	a0,a0,-980 # 7ae8 <malloc+0x1e96>
    ...
    4eda:	6121                	addi	sp,sp,64
    4edc:	8082                	ret
    printf("%s: read bigfile wrong total\n", s);
    4ede:	85d6                	mv	a1,s5
    4ee0:	00003517          	auipc	a0,0x3
    4ee4:	cd050513          	addi	a0,a0,-816 # 7bb0 <malloc+0x1f5e>
...
0000000000004efa <fsfull>:
{
    ...
    4f14:	1100                	addi	s0,sp,160
  printf("fsfull test\n");
    4f16:	00003517          	auipc	a0,0x3
    4f1a:	cba50513          	addi	a0,a0,-838 # 7bd0 <malloc+0x1f7e>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4fa2:	f6040593          	addi	a1,s0,-160
    4fa6:	00003517          	auipc	a0,0x3
    4faa:	c4a50513          	addi	a0,a0,-950 # 7bf0 <malloc+0x1f9e>
  ...
  printf("fsfull test finished\n");
    ...
    5044:	610d                	addi	sp,sp,160
    5046:	8082                	ret
    int total = 0;
    5048:	4981                	li	s3,0
      int cc = write(fd, buf, BSIZE);
    504a:	00007a97          	auipc	s5,0x7
    504e:	d66a8a93          	addi	s5,s5,-666 # bdb0 <buf>
      if(cc < BSIZE)
    ...
    5076:	b8e50513          	addi	a0,a0,-1138 # 7c00 <malloc+0x1fae>
...
0000000000005094 <badwrite>:
{
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5120:	cc458593          	addi	a1,a1,-828 # 5de0 <malloc+0x18e>
    ...
    5136:	b1650513          	addi	a0,a0,-1258 # 7c48 <malloc+0x1ff6>
    ...
    5150:	ae450513          	addi	a0,a0,-1308 # 7c30 <malloc+0x1fde>
    ...
    516a:	aca50513          	addi	a0,a0,-1334 # 7c30 <malloc+0x1fde>
  ...
  unlink("junk");
    ...
    518e:	a9e50513          	addi	a0,a0,-1378 # 7c28 <malloc+0x1fd6>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51e4:	c0098993          	addi	s3,s3,-1024 # 5de0 <malloc+0x18e>
      uint64 a = (uint64) sbrk(4096);
    ...
    5216:	a8650513          	addi	a0,a0,-1402 # 7c98 <malloc+0x2046>
    ...
    5230:	a2c50513          	addi	a0,a0,-1492 # 7c58 <malloc+0x2006>
    ...
    524a:	a3250513          	addi	a0,a0,-1486 # 7c78 <malloc+0x2026>
  ...
  while(1){
    ...
    528e:	c105                	beqz	a0,52ae <countfree+0x10a>
      break;
    n += 1;
    5290:	2485                	addiw	s1,s1,1
  while(1){
    5292:	b7dd                	j	5278 <countfree+0xd4>
      printf("read() failed in countfree()\n");
    5294:	00003517          	auipc	a0,0x3
    5298:	a2450513          	addi	a0,a0,-1500 # 7cb8 <malloc+0x2066>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    52e8:	9f450513          	addi	a0,a0,-1548 # 7cd8 <malloc+0x2086>
  ...
  if(pid == 0) {
    ...
    5318:	9ec50513          	addi	a0,a0,-1556 # 7d00 <malloc+0x20ae>
    ...
    5334:	6145                	addi	sp,sp,48
    5336:	8082                	ret
    printf("runtest: fork error\n");
    5338:	00003517          	auipc	a0,0x3
    533c:	9b050513          	addi	a0,a0,-1616 # 7ce8 <malloc+0x2096>
    ...
    5364:	9a850513          	addi	a0,a0,-1624 # 7d08 <malloc+0x20b6>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53ae:	d7678793          	addi	a5,a5,-650 # 8120 <malloc+0x24ce>
    53b2:	bd040713          	addi	a4,s0,-1072
    53b6:	00003317          	auipc	t1,0x3
    53ba:	15a30313          	addi	t1,t1,346 # 8510 <malloc+0x28be>
    ...
    53de:	03078793          	addi	a5,a5,48
    53e2:	03070713          	addi	a4,a4,48
  ...
  printf("usertests starting\n");
    ...
    53ee:	9de50513          	addi	a0,a0,-1570 # 7dc8 <malloc+0x2176>
  ...
  if(fail){
    ...
    5428:	95c50513          	addi	a0,a0,-1700 # 7d80 <malloc+0x212e>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5444:	8d058593          	addi	a1,a1,-1840 # 7d10 <malloc+0x20be>
    ...
    545a:	cca78793          	addi	a5,a5,-822 # 8120 <malloc+0x24ce>
    545e:	bd040713          	addi	a4,s0,-1072
    5462:	00003317          	auipc	t1,0x3
    5466:	0ae30313          	addi	t1,t1,174 # 8510 <malloc+0x28be>
    ...
    548a:	03078793          	addi	a5,a5,48
    548e:	03070713          	addi	a4,a4,48
    5492:	fc679ce3          	bne	a5,t1,546a <main+0xf8>
    printf("continuous usertests starting\n");
    5496:	00003517          	auipc	a0,0x3
    549a:	94a50513          	addi	a0,a0,-1718 # 7de0 <malloc+0x218e>
    549e:	00000097          	auipc	ra,0x0
    54a2:	6fc080e7          	jalr	1788(ra) # 5b9a <printf>
        printf("SOME TESTS FAILED\n");
    54a6:	00003a97          	auipc	s5,0x3
    54aa:	8c2a8a93          	addi	s5,s5,-1854 # 7d68 <malloc+0x2116>
        if(continuous != 2)
    54ae:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    54b0:	00003b17          	auipc	s6,0x3
    54b4:	898b0b13          	addi	s6,s6,-1896 # 7d48 <malloc+0x20f6>
    54b8:	a0dd                	j	559e <main+0x22c>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    54ba:	00003597          	auipc	a1,0x3
    54be:	85e58593          	addi	a1,a1,-1954 # 7d18 <malloc+0x20c6>
    ...
    54e2:	84250513          	addi	a0,a0,-1982 # 7d20 <malloc+0x20ce>
  ...
  if(fail){
    ...
    5554:	81850513          	addi	a0,a0,-2024 # 7d68 <malloc+0x2116>
    ...
    556e:	84650513          	addi	a0,a0,-1978 # 7db0 <malloc+0x215e>
...
{
    55c6:	1141                	addi	sp,sp,-16
    55c8:	e422                	sd	s0,8(sp)
    55ca:	0800                	addi	s0,sp,16
  char *os;
...
strlen(const char *s)
{
    560e:	1141                	addi	sp,sp,-16
    5610:	e422                	sd	s0,8(sp)
    5612:	0800                	addi	s0,sp,16
  int n;
...
memset(void *dst, int c, uint n)
{
  ...
  for(i = 0; i < n; i++){
    ...
    5640:	87aa                	mv	a5,a0
    5642:	1602                	slli	a2,a2,0x20
    5644:	9201                	srli	a2,a2,0x20
    5646:	00a60733          	add	a4,a2,a0
    cdst[i] = c;
    564a:	00b78023          	sb	a1,0(a5)
  for(i = 0; i < n; i++){
    564e:	0785                	addi	a5,a5,1
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    56a0:	89a6                	mv	s3,s1
    56a2:	2485                	addiw	s1,s1,1
    56a4:	0344d863          	bge	s1,s4,56d4 <gets+0x56>
    cc = read(0, &c, 1);
    56a8:	4605                	li	a2,1
    56aa:	faf40593          	addi	a1,s0,-81
    56ae:	4501                	li	a0,0
...
atoi(const char *s)
{
  ...
  n = 0;
    5752:	4501                	li	a0,0
    n = n*10 + *s++ - '0';
    5754:	0705                	addi	a4,a4,1
    5756:	0025179b          	slliw	a5,a0,0x2
    575a:	9fa9                	addw	a5,a5,a0
    575c:	0017979b          	slliw	a5,a5,0x1
    5760:	9fb5                	addw	a5,a5,a3
    5762:	fd07851b          	addiw	a0,a5,-48
  while('0' <= *s && *s <= '9')
    5766:	00074683          	lbu	a3,0(a4)
    576a:	fd06879b          	addiw	a5,a3,-48
    576e:	0ff7f793          	zext.b	a5,a5
    5772:	fef671e3          	bgeu	a2,a5,5754 <atoi+0x1c>
  return n;
}
    5776:	6422                	ld	s0,8(sp)
    5778:	0141                	addi	sp,sp,16
    577a:	8082                	ret
  n = 0;
    577c:	4501                	li	a0,0
...
{
    5780:	1141                	addi	sp,sp,-16
    5782:	e422                	sd	s0,8(sp)
    5784:	0800                	addi	s0,sp,16
  char *dst;
  const char *src;
  ...
  if (src > dst) {
    ...
    578e:	1602                	slli	a2,a2,0x20
    5790:	9201                	srli	a2,a2,0x20
  ...
  return vdst;
    ...
    57b8:	fff6079b          	addiw	a5,a2,-1 # 2fff <iputtest+0x8b>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    591a:	c5a50513          	addi	a0,a0,-934 # 8570 <digits>
    591e:	883a                	mv	a6,a4
  ...
  if(neg)
    ...
    buf[i++] = '-';
    5946:	fd070793          	addi	a5,a4,-48
    594a:	00878733          	add	a4,a5,s0
    594e:	02d00793          	li	a5,45
    5952:	fef70823          	sb	a5,-16(a4)
    5956:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    595a:	02e05863          	blez	a4,598a <printint+0x96>
    595e:	fc040793          	addi	a5,s0,-64
    5962:	00e78933          	add	s2,a5,a4
    5966:	fff78993          	addi	s3,a5,-1
    596a:	99ba                	add	s3,s3,a4
    596c:	377d                	addiw	a4,a4,-1
    596e:	1702                	slli	a4,a4,0x20
    5970:	9301                	srli	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    5aa8:	accb8b93          	addi	s7,s7,-1332 # 8570 <digits>
    5aac:	03c9d793          	srli	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5ac0:	0992                	slli	s3,s3,0x4
    5ac2:	397d                	addiw	s2,s2,-1
    ...
    5afc:	a1890913          	addi	s2,s2,-1512 # 8510 <malloc+0x28be>
        while(*s != 0){
    5b00:	02800593          	li	a1,40
    5b04:	bff1                	j	5ae0 <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
    5b06:	008b8913          	addi	s2,s7,8
...
{
    5b6c:	715d                	addi	sp,sp,-80
    5b6e:	ec06                	sd	ra,24(sp)
    5b70:	e822                	sd	s0,16(sp)
    5b72:	1000                	addi	s0,sp,32
...
free(void *ap)
{
    5bd0:	1141                	addi	sp,sp,-16
    5bd2:	e422                	sd	s0,8(sp)
    5bd4:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5bd6:	ff050693          	addi	a3,a0,-16
    ...
    5c06:	00e6ea63          	bltu	a3,a4,5c1a <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    5c20:	02059813          	slli	a6,a1,0x20
    5c24:	01c85713          	srli	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    5c34:	02061593          	slli	a1,a2,0x20
    5c38:	01c5d713          	srli	a4,a1,0x1c
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5c66:	02051493          	slli	s1,a0,0x20
    5c6a:	9081                	srli	s1,s1,0x20
    5c6c:	04bd                	addi	s1,s1,15
    5c6e:	8091                	srli	s1,s1,0x4
    5c70:	0014899b          	addiw	s3,s1,1
    5c74:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5ca2:	8f290913          	addi	s2,s2,-1806 # 8590 <freep>
  if(p == (char*)-1)
    5ca6:	5afd                	li	s5,-1
    5ca8:	a895                	j	5d1c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5caa:	00009797          	auipc	a5,0x9
    5cae:	10678793          	addi	a5,a5,262 # edb0 <base>
    ...
    5cca:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5ccc:	02071693          	slli	a3,a4,0x20
    5cd0:	01c6d713          	srli	a4,a3,0x1c
