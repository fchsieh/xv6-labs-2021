...
main(void)
{
  ...
  3a:	84290913          	addi	s2,s2,-1982 # 878 <malloc+0xf4>
  3e:	854a                	mv	a0,s2
  ...
  6e:	85e50513          	addi	a0,a0,-1954 # 8c8 <malloc+0x144>
  ...
  8c:	7e850513          	addi	a0,a0,2024 # 870 <malloc+0xec>
  90:	00000097          	auipc	ra,0x0
  94:	31c080e7          	jalr	796(ra) # 3ac <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00000517          	auipc	a0,0x0
  9e:	7d650513          	addi	a0,a0,2006 # 870 <malloc+0xec>
  a2:	00000097          	auipc	ra,0x0
  a6:	302080e7          	jalr	770(ra) # 3a4 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00000517          	auipc	a0,0x0
  b0:	7e450513          	addi	a0,a0,2020 # 890 <malloc+0x10c>
  ...
  ca:	89a58593          	addi	a1,a1,-1894 # 960 <argv>
  ce:	00000517          	auipc	a0,0x0
  d2:	7da50513          	addi	a0,a0,2010 # 8a8 <malloc+0x124>
  d6:	00000097          	auipc	ra,0x0
  da:	2c6080e7          	jalr	710(ra) # 39c <exec>
      printf("init: exec sh failed\n");
  de:	00000517          	auipc	a0,0x0
  e2:	7d250513          	addi	a0,a0,2002 # 8b0 <malloc+0x12c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 44c:	50050513          	addi	a0,a0,1280 # 948 <digits>
 450:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 550:	3a470713          	addi	a4,a4,932 # 8f0 <malloc+0x16c>
 ...
 5da:	372b8b93          	addi	s7,s7,882 # 948 <digits>
 ...
 62e:	2be90913          	addi	s2,s2,702 # 8e8 <malloc+0x164>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7d4:	1a090913          	addi	s2,s2,416 # 970 <freep>
  if(p == (char*)-1)
 7d8:	5afd                	li	s5,-1
 7da:	a895                	j	84e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7dc:	00000797          	auipc	a5,0x0
 7e0:	19c78793          	addi	a5,a5,412 # 978 <base>
