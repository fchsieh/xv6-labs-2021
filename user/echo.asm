...
main(int argc, char *argv[])
{
  ...
  34:	7d0a8a93          	addi	s5,s5,2000 # 800 <malloc+0xe6>
  ...
  76:	79658593          	addi	a1,a1,1942 # 808 <malloc+0xee>
  7a:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e2:	49250513          	addi	a0,a0,1170 # 870 <digits>
 3e6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e6:	33670713          	addi	a4,a4,822 # 818 <malloc+0xfe>
 ...
 570:	304b8b93          	addi	s7,s7,772 # 870 <digits>
 ...
 5c4:	25090913          	addi	s2,s2,592 # 810 <malloc+0xf6>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 76a:	12290913          	addi	s2,s2,290 # 888 <freep>
  if(p == (char*)-1)
 76e:	5afd                	li	s5,-1
 770:	a895                	j	7e4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 772:	00000797          	auipc	a5,0x0
 776:	11e78793          	addi	a5,a5,286 # 890 <base>
