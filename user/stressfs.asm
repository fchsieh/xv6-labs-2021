...
main(int argc, char *argv[])
{
  ...
  1a:	89a78793          	addi	a5,a5,-1894 # 8b0 <malloc+0x118>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	85450513          	addi	a0,a0,-1964 # 880 <malloc+0xe8>
  ...
  6c:	83050513          	addi	a0,a0,-2000 # 898 <malloc+0x100>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	7f250513          	addi	a0,a0,2034 # 8a8 <malloc+0x110>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 564:	36870713          	addi	a4,a4,872 # 8c8 <malloc+0x130>
 ...
 5ee:	336b8b93          	addi	s7,s7,822 # 920 <digits>
 ...
 642:	28290913          	addi	s2,s2,642 # 8c0 <malloc+0x128>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7f4:	15078793          	addi	a5,a5,336 # 940 <base>
